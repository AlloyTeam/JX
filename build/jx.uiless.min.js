...
Jx().$package(function(i){var h,p,t,r,s,u,k,d,n,q,g;h=function(a){return typeof a==="undefined"};p=function(a){return a===null};t=function(a){return(a===0||a)&&a.constructor===Number};s=function(a){return(a===false||a)&&a.constructor===Boolean};r=function(a){return(a===""||a)&&a.constructor===String};u=function(a){return a&&(a.constructor===Object||Object.prototype.toString.call(a)==="[object Object]")};k=function(a){return a&&(a.constructor===Array||Object.prototype.toString.call(a)==="[object Array]")};
d=function(a){return a&&a.callee&&t(a.length)?true:false};n=function(a){return a&&a.constructor===Function};q=function(a){var b=arguments,f,e;if(b.length===1){a=this;b=0}else{a=b[0]||{};b=1}for(;b<arguments.length;b++){e=arguments[b];for(f in e){var l=a[f],m=e[f];if(l!==m)if(m&&u(m)&&!k(m)&&!m.nodeType&&!n(m)){l=a[f]||{};a[f]=q(l,m||(m.length!=null?[]:{}))}else if(m!==undefined)a[f]=m}}return a};g=function(){var a=arguments.length,b=arguments[a-1];b.init=b.init||function(){};if(a===2){a=arguments[0].extend;
var f=function(){};f.prototype=a.prototype;var e=function(){this.init.apply(this,arguments)};e.superClass=a.prototype;e.callSuper=function(l,m){var w=Array.prototype.slice,z=w.call(arguments,2);(m=e.superClass[m])&&m.apply(l,z.concat(w.call(arguments)))};e.prototype=new f;e.prototype.constructor=e;i.extend(e.prototype,b);e.prototype.init=function(){b.init.apply(this,arguments)};return e}else if(a===1){a=function(){return this.init.apply(this,arguments)};a.prototype=b;return a}};var c=new g({init:function(a,
b,f,e,l){var m=a.concat();if(e)m=a;this.timeout=window.setTimeout(function(){var w=+new Date;do b.call(f,m.shift());while(m.length>0&&+new Date-w<50);if(m.length>0)this.timeout=window.setTimeout(arguments.callee,25);else l&&l(a)},25)},stop:function(){clearTimeout(this.timeout)}});i.isUndefined=h;i.isNull=p;i.isNumber=t;i.isString=r;i.isBoolean=s;i.isObject=u;i.isArray=k;i.isArguments=d;i.isFunction=n;i.$typeof=function(a){return h(a)?"undefined":p(a)?"null":t(a)?"number":s(a)?"boolean":r(a)?"string":
u(a)?"object":k(a)?"array":d(a)?"arguments":n(a)?"function":"other"};i.$return=function(a){return i.isFunction(a)?a:function(){return a}};i.$try=function(){var a,b=arguments.length,f;for(a=0;a<b;a++)try{f=arguments[a]();break}catch(e){i.out("C.\u9519\u8bef\uff1a["+e.name+"] "+e.message+", "+e.fileName+", \u884c\u53f7:"+e.lineNumber+"; stack:"+typeof e.stack,2)}return f};i.emptyFunc=function(){};i.clone=function(a){var b=function(){};b.prototype=a;return new b};i.getLength=function(a){var b,f=0;for(b in a)a.hasOwnProperty(b)&&
f++;return f};i.checkJSON=function(){return true};i.random=function(a,b){return Math.floor(Math.random()*(b-a+1)+a)};i.extend=q;i.now=function(){return+new Date};i.timedChunk=function(a,b,f,e,l){var m=a.concat();if(e)m=a;window.setTimeout(function(){var w=+new Date;do b.call(f,m.shift());while(m.length>0&&+new Date-w<50);if(m.length>0)window.setTimeout(arguments.callee,25);else l&&l(a)},25)};i.rebuild=function(a,b){b=b||{};a.$$rebuildedFunc=a.$$rebuildedFunc||function(){var f,e;f=b.contextObj||this;
...
Jx().$package(function(i){i.array=i.array||{};var h=i.array,p,t,r,s,u,k,d,n,q,g,c,a;p=Array.prototype.indexOf?function(){var b=Array.prototype.slice.call(arguments,1);return Array.prototype.indexOf.apply(arguments[0],b)}:function(b,f,e){if(e==null)e=0;else if(e<0)e=Math.max(0,b.length+e);for(e=e;e<b.length;e++)if(b[e]===f)return e;return-1};t=Array.prototype.lastIndexOf?function(){var b=Array.prototype.slice.call(arguments,1);return Array.prototype.lastIndexOf.apply(arguments[0],b)}:function(b,f,
e){if(e==null)e=b.length-1;else if(e<0)e=Math.max(0,b.length+e);for(e=e;e>=0;e--)if(b[e]===f)return e;return-1};r=Array.prototype.forEach?function(){var b=Array.prototype.slice.call(arguments,1);return Array.prototype.forEach.apply(arguments[0],b)}:function(b,f,e){var l=b.length;if(typeof f!="function")throw new TypeError;for(var m=0;m<l;m++)m in b&&f.call(e,b[m],m,b)};s=Array.prototype.filter?function(){var b=Array.prototype.slice.call(arguments,1);return Array.prototype.filter.apply(arguments[0],
b)}:function(b,f,e){var l=b.length;if(typeof f!="function")throw new TypeError;for(var m=[],w=0;w<l;w++)if(w in b){var z=b[w];f.call(e,z,w,b)&&m.push(z)}return m};u=Array.prototype.some?function(){var b=Array.prototype.slice.call(arguments,1);return Array.prototype.some.apply(arguments[0],b)}:function(b,f,e){var l=b.length;if(typeof f!="function")throw new TypeError;for(var m=0;m<l;m++)if(m in b&&f.call(e,b[m],m,b))return true;return false};k=Array.prototype.map?function(){var b=Array.prototype.slice.call(arguments,
1);return Array.prototype.map.apply(arguments[0],b)}:function(b,f,e){var l=b.length;if(typeof f!="function")throw new TypeError;for(var m=Array(l),w=0;w<l;w++)if(w in b)m[w]=f.call(e,b[w],w,b);return m};d=Array.prototype.every?function(){var b=Array.prototype.slice.call(arguments,1);return Array.prototype.every.apply(arguments[0],b)}:function(b,f,e){var l=b.length;if(typeof f!="function")throw new TypeError;for(var m=0;m<l;m++)if(m in b&&!f.call(e,b[m],m,b))return false;return true};n=Array.prototype.reduce?
function(){var b=Array.prototype.slice.call(arguments,1);return Array.prototype.reduce.apply(arguments[0],b)}:function(b,f){var e=b.length>>>0;if(typeof f!="function")throw new TypeError;if(e==0&&arguments.length==2)throw new TypeError;var l=0;if(arguments.length>=3)var m=arguments[2];else{do{if(l in b){m=b[l++];break}if(++l>=e)throw new TypeError;}while(1)}for(;l<e;l++)if(l in b)m=f.call(null,m,b[l],l,b);return m};q=Array.prototype.reduceRight?function(){var b=Array.prototype.slice.call(arguments,
1);return Array.prototype.reduceRight.apply(arguments[0],b)}:function(b,f){var e=b.length>>>0;if(typeof f!="function")throw new TypeError;if(e==0&&arguments.length==2)throw new TypeError;e=e-1;if(arguments.length>=3)var l=arguments[2];else{do{if(e in b){l=b[e--];break}if(--e<0)throw new TypeError;}while(1)}for(;e>=0;e--)if(e in b)l=f.call(null,l,b[e],e,b);return l};g=function(b){var f=i.$typeof(b);return f?f!="array"&&f!="arguments"?[b]:b:[]};c=function(b,f){return p(b,f)>-1};a=function(b){for(var f=
[],e=0,l=b.length;e<l;e++)c(f,b[e])||f.push(b[e]);return f};h.indexOf=p;h.lastIndexOf=t;h.forEach=r;h.filter=s;h.some=u;h.map=k;h.every=d;h.reduce=n;h.reduceRight=q;h.toArray=g;h.remove=function(b,f){f=g(f);var e,l,m=false;for(e=0;e<f.length;e++)for(l=0;l<b.length;l++)if(b[l]===f[e]){b.splice(l,1);m=true}return m};h.replace=function(b,f,e){for(;0<b.length;ij++)if(b[0]===f){b[0]=e;return true}return false};h.bubbleSort=function(b,f){f=f||function(A,x){return A-x};for(var e=b.length,l,m,w=0;w<e-1;w++){m=
false;for(var z=e-1;z>w;z--)if(f(b[z],b[z-1])<0){m=true;l=b[z-1];b[z-1]=b[z];b[z]=l}if(!m)break}return b};h.binarySearch=function(b,f,e){for(var l=0,m=b.length,w=Math.floor(b.length/2);m!=w;){if(e(f,b[w])>0)l=w+1;else m=w;w=Math.floor((l+m)/2)}return w};h.contains=c;h.uniquelize=a;h.intersect=function(b,f){for(var e=[],l=0,m=b.length;l<m;l++)c(f,b[l])&&e.push(b[l]);return e};h.minus=function(b,f){for(var e=[],l=0,m=b.length;l<m;l++)c(f,b[l])||e.push(b[l]);return e};h.union=function(b,f){return a(b.concat(f))}});
...
Jx().$package(function(i){var h,p,t,r,s,u,k=[],d,n,q,g,c;i.event=i.event||{};h=i.event;c=function(a,b){if(!a)a=window.event;b=b||a.srcElement;var f=document,e=f.documentElement;f=f.body;e={_event:a,type:a.type,target:a.srcElement,currentTarget:b,relatedTarget:a.fromElement?a.fromElement:a.toElement,eventPhase:a.srcElement==b?2:3,clientX:a.clientX,clientY:a.clientY,screenX:a.screenX,screenY:a.screenY,layerX:a.offsetX,layerY:a.offsetY,pageX:a.clientX+(e&&e.scrollLeft||f&&f.scrollLeft||0)-(e&&e.clientLeft||
f&&f.clientLeft||0),pageY:a.clientY+(e&&e.scrollTop||f&&f.scrollTop||0)-(e&&e.clientTop||f&&f.clientTop||0),wheelDelta:a.wheelDelta,altKey:a.altKey,ctrlKey:a.ctrlKey,shiftKey:a.shiftKey,charCode:a.keyCode,keyCode:a.keyCode,stopPropagation:function(){this._event.cancelBubble=true},preventDefault:function(){this._event.returnValue=false}};f=a.type.toLowerCase();if(f=="mouseover")e.relatedTarget=a.fromElement;else if(f=="mouseout")e.relatedTarget=a.toElement;if(!i.isUndefined(a.button)){f=a.button;var l=
{0:-1,1:0,2:2,3:-1,4:1};e.button=i.isUndefined(l[f])?f:l[f]}return e};if(document.addEventListener){p=function(a,b,f,e){u["on"+b]?u["on"+b](a,b,f,e):t(a,b,f)};t=function(a,b,f){var e=false;a||i.out("targetModel undefined:"+b+f);if(!a._eventTypes)a._eventTypes={};a._eventTypes[b]||(a._eventTypes[b]=[]);a.addEventListener(b,f,false);a=a._eventTypes[b];for(b=0;b<a.length;b++)if(a[b]==f){e=true;break}e||a.push(f)};r=function(a,b,f){if(u["off"+b])u["off"+b](a,b,f);else arguments.length==3?s(a,b,f):s(a,
b)};s=function(a,b,f){if(b)if(arguments.length==3){if(f){a.removeEventListener(b,f,false);if(a._eventTypes&&a._eventTypes[b])for(var e=a._eventTypes[b],l=0;l<e.length;l++)if(e[l]===f){e[l]=null;e.splice(l,1);break}}}else{if(a._eventTypes&&a._eventTypes[b]){e=a._eventTypes[b];for(l=0;l<e.length;l++)a.removeEventListener(b,e[l],false);a._eventTypes[b]=[]}}else if(a._eventTypes){var m=a._eventTypes,w;for(w in m){e=a._eventTypes[w];for(l=0;l<e.length;l++)a.removeEventListener(w,e[l],false)}}}}else if(document.attachEvent){p=
function(a,b,f,e){u["on"+b]?u["on"+b](a,b,f,e):t(a,b,f)};t=function(a,b,f){if(h._find(arguments)==-1){var e=function(w){w=c(w,a);if(Function.prototype.call)f.call(a,w);else{a._currentHandler=f;a._currentHandler(w);a._currentHandler=null}};a.attachEvent("on"+b,e);e={element:a,eventType:b,handler:f,wrappedEvent:e};var l=(a.document||a).parentWindow||window,m=h._uid();if(!l._allHandlers)l._allHandlers={};l._allHandlers[m]=e;if(!a._handlers)a._handlers=[];a._handlers.push(m);if(!l._onunloadEventRegistered){l._onunloadEventRegistered=
true;l.attachEvent("onunload",h._removeAllEvents)}}};r=function(a,b,f){if(u["off"+b])u["off"+b](a,b,f);else arguments.length==3?s(a,b,f):s(a,b)};s=function(a){var b=h._find(arguments);if(b!=-1){for(var f=(a.document||a).parentWindow||window,e=0;e<b.length;e++){var l=b[e],m=a._handlers[l],w=f._allHandlers[m];a.detachEvent("on"+w.eventType,w.wrappedEvent);a._handlers[l]=null;a._handlers.splice(l,1);delete f._allHandlers[m]}if(a._handlers&&a._handlers.length==0)a._handlers=null}};h._find=function(a){var b=
a[0],f=a[1],e=a[2],l=b._handlers;if(!l)return-1;b=(b.document||b).parentWindow||window;var m=[];if(a.length===3)for(a=l.length-1;a>=0;a--){var w=l[a];w=b._allHandlers[w];if(w.eventType==f&&w.handler==e){m.push(a);return m}}else if(a.length===2){for(a=l.length-1;a>=0;a--){w=l[a];w=b._allHandlers[w];w.eventType==f&&m.push(a)}if(m.length>0)return m}else if(a.length===1){for(a=l.length-1;a>=0;a--)m.push(a);if(m.length>0)return m}return-1};h._removeAllEvents=function(){for(var a in this._allHandlers){var b=
this._allHandlers[a];b.element.detachEvent("on"+b.eventType,b.wrappedEvent);b.element._handlers=null;delete this._allHandlers[a]}};h._counter=0;h._uid=function(){return"h"+h._counter++}}u={ondrag:function(a,b,f){var e,l,m=false,w=function(x){if(!(!i.browser.mobileSafari&&x.button!==0)){if(i.browser.mobileSafari){x.stopPropagation();x=x.touches[0];e=x.pageX;l=x.pageY}else{x.stopPropagation();x.preventDefault();e=x.clientX;l=x.clientY}m=false;if(i.browser.mobileSafari){h.addEventListener(document,"touchmove",
z);h.addEventListener(a,"touchend",A)}else h.addEventListener(document,"mousemove",z)}},z=function(x){if(!(!i.browser.mobileSafari&&x.button!==0)){var E,D;x.stopPropagation();if(i.browser.mobileSafari){D=x.changedTouches[0];E=D.pageX;D=D.pageY}else{E=x.clientX;D=x.clientY}if(Math.abs(e-E)+Math.abs(l-D)>2){if(i.browser.mobileSafari){h.removeEventListener(document,"touchmove",z);h.removeEventListener(a,"touchend",A)}else h.removeEventListener(document,"mousemove",z);if(!m){f.call(a,x);m=true}}}},A=
function(x){if(!(!i.browser.mobileSafari&&x.button!==0))if(i.browser.mobileSafari){h.removeEventListener(document,"touchmove",z);if(m){x.stopPropagation();x.preventDefault()}}else h.removeEventListener(document,"mousemove",z)};if(i.browser.mobileSafari)h.addEventListener(a,"touchstart",w);else{h.addEventListener(a,"mousedown",w);h.addEventListener(a,"mouseup",A)}k.push({element:a,eventType:b,handler:f,actions:[w,A]})},offdrag:function(a,b,f){for(var e in k)if(k[e].handler==f&&k[e].element==a&&k[e].eventType==
b){if(i.browser.mobileSafari){h.removeEventListener(a,"touchstart",k[e].actions[0]);h.removeEventListener(a,"touchend",k[e].actions[1])}else{h.removeEventListener(a,"mousedown",k[e].actions[0]);h.removeEventListener(a,"mouseup",k[e].actions[1])}k.splice(e,1);break}},oncustomclick:function(a,b,f,e){var l,m,w=false,z=false,A;e=e?e:{};var x=e.longtouchable,E=-1;e=function(o){w=false;if(!(!i.browser.mobileSafari&&o.button!==0)){var v;if(i.browser.mobileSafari){v=o.changedTouches[0];l=v.pageX;m=v.pageY}else{l=
...
o.button;if(!(!i.browser.mobileSafari&&o.button!==0))if(i.browser.mobileSafari)touch=o.changedTouches[0]},B=function(o){if(i.browser.mobileSafari){touch=o.changedTouches[0];var v=touch.pageX;o=touch.pageY}else{v=o.clientX;o=o.clientY}if(w=Math.abs(l-v)+Math.abs(m-o)>1){clearTimeout(A);A=null;if(i.browser.mobileSafari){h.removeEventListener(a,"touchmove",B);h.removeOriginalEventListener(a,"touchend",j)}else{h.removeEventListener(a,"mousemove",B);h.removeOriginalEventListener(a,"click",j)}}},j=function(o){clearTimeout(A);
A=null;z=true;if(!(!i.browser.mobileSafari&&E!==0)){var v;if(i.browser.mobileSafari){v=o.changedTouches[0];var y=v.pageX;v=v.pageY}else{y=o.clientX;v=o.clientY}if(Math.abs(l-y)+Math.abs(m-v)<1){w=false;f.call(a,o,0)}}};if(i.browser.mobileSafari)h.addEventListener(a,"touchstart",e);else{h.addEventListener(a,"mousedown",e);h.addEventListener(a,"mouseup",D)}k.push({element:a,eventType:b,handler:f,actions:[e,B,D,j]})},offcustomclick:function(a,b,f){for(var e in k)if(k[e].handler==f&&k[e].element==a&&
k[e].eventType==b){if(i.browser.mobileSafari){h.removeEventListener(a,"touchstart",k[e].actions[0]);h.removeEventListener(a,"touchmove",k[e].actions[1]);h.removeOriginalEventListener(a,"touchend",k[e].actions[3])}else{h.removeEventListener(a,"mousedown",k[e].actions[0]);h.removeEventListener(a,"mousemove",k[e].actions[1]);h.removeEventListener(a,"mouseup",k[e].actions[2]);h.removeOriginalEventListener(a,"click",k[e].actions[3])}k.splice(e,1);break}},oncontextmenu:function(a,b,f){if(i.browser.ie==
9){var e=function(l){l=c(l,a);f.call(a,l)};a.attachEvent("oncontextmenu",e);k.push({element:a,eventType:b,handler:f,actions:[e]})}else h.addOriginalEventListener(a,b,f)},offcontextmenu:function(a,b,f){if(i.browser.ie==9)for(var e in k){if(k[e].handler==f&&k[e].element==a&&k[e].eventType==b){a.detachEvent("oncontextmenu",k[e].actions[0]);k.splice(e,1);break}}else h.removeOriginalEventListener(a,b,f)},onmousewheel:function(a,b,f){if(i.browser.firefox){var e=function(l){l.wheelDelta=-40*l.detail;f.call(a,
l)};h.addOriginalEventListener(a,"DOMMouseScroll",e);k.push({element:a,eventType:b,handler:f,actions:[e]})}else h.addOriginalEventListener(a,"mousewheel",f)},offmousewheel:function(a,b,f){if(i.browser.firefox)for(var e in k){if(k[e].handler==f&&k[e].element==a&&k[e].eventType==b){h.removeOriginalEventListener(a,"DOMMouseScroll",k[e].actions[0]);k.splice(e,1);break}}else h.removeOriginalEventListener(a,"mousewheel",f)},onmouseenter:function(a,b,f){var e=function(l){var m=l.relatedTarget;if(m)if(this.compareDocumentPosition){var w=
this.compareDocumentPosition(m);m==this||w==20||w==0||f.call(this,l)}else m==this||this.contains(m)||f.call(this,l);else f.call(this,l)};h.addEventListener(a,"mouseover",e);k.push({element:a,eventType:b,handler:f,actions:[e]})},offmouseenter:function(a,b,f){for(var e in k)if(k[e].handler==f&&k[e].element==a&&k[e].eventType==b){h.removeEventListener(a,"mouseover",k[e].actions[0]);k.splice(e,1);break}},onmouseleave:function(a,b,f){var e=function(l){var m=l.relatedTarget;if(m)if(this.compareDocumentPosition){m=
this.compareDocumentPosition(m);m==20||m==0||f.call(this,l)}else this.contains(m)||f.call(this,l);else f.call(this,l)};h.addEventListener(a,"mouseout",e);k.push({element:a,eventType:b,handler:f,actions:[e]})},offmouseleave:function(a,b,f){for(var e in k)if(k[e].handler==f&&k[e].element==a&&k[e].eventType==b){h.removeEventListener(a,"mouseout",k[e].actions[0]);k.splice(e,1);break}},oninput:function(a,b,f){if(i.browser.ie){var e=function(l){if(l.propertyName.toLowerCase()=="value"){l=c(l,a);f.call(a,
l)}};a.attachEvent("onpropertychange",e);k.push({element:a,eventType:b,handler:f,actions:[e]});i.browser.ie==9&&h.addOriginalEventListener(a,"change",f)}else h.addOriginalEventListener(a,"input",f)},offinput:function(a,b,f){if(i.browser.ie){for(var e in k)if(k[e].handler==f&&k[e].element==a&&k[e].eventType==b){a.detachEvent("onpropertychange",k[e].actions[0]);k.splice(e,1);break}i.browser.ie==9&&h.removeOriginalEventListener(a,"change",f)}else h.removeOriginalEventListener(a,"input",f)}};d=function(a){if(d.done)return a();
...
q.prototype.deliver=function(a){i.array.forEach(this.subscribers,function(b){b(a)})};q.prototype.unsubscribe=function(a){this.subscribers=i.array.filter(this.subscribers,function(b){return b!==a});return a};g=function(a,b,f){var e,l;if(f){b="on"+b;if(!a._$events)a._$events={};if(a._$events[b]){if(a._$events[b].length==0)a._$events[b]=[]}else a._$events[b]=[];a=a._$events[b];b=a.length;e=-1;for(l=0;l<b;l++)if(a[l]==f){e=l;break}e===-1&&a.push(f)}else i.out(">>> \u6dfb\u52a0\u7684\u89c2\u5bdf\u8005\u65b9\u6cd5\u4e0d\u5b58\u5728\uff1a"+
a+b+f)};h.addEventListener=p;h.removeEventListener=r;h.addOriginalEventListener=t;h.removeOriginalEventListener=s;h.on=h.addEventListener;h.off=h.removeEventListener;h.onDomReady=d;h.Publish=q;h.addObserver=g;h.addObservers=function(a){var b=a.targetModel;a=a.eventMapping;for(var f in a)g(b,f,a[f])};h.notifyObservers=function(a,b,f){var e;b="on"+b;var l=true;if(a._$events&&a._$events[b]){b=a._$events[b];if(b.length>0)for(e=0;e<b.length;e++)if(b[e].apply(a,[f])===false)l=false}return l};h.removeObserver=
function(a,b,f){var e,l=false,m,w=a._$events;if(f){if(w){b="on"+b;if(a=w[b]){m=a.length;for(e=0;e<m;e++)if(a[e]==f){a[e]=null;a.splice(e,1);l=true;break}}}}else if(b){if(w){b="on"+b;if(a=w[b]){m=a.length;for(e=0;e<m;e++)a[e]=null;delete w[b];l=true}}}else if(a)if(w){for(e in w)delete w[e];delete a._$events;l=true}return l}});
Jx().$package(function(i){i.string=i.string||{};var h=i.string,p,t,r,s,u,k,d,n,q,g;p=function(){function c(B){l="var ";m={};m[e]=1;B=B.split(b);for(var j="",o=0,v=B.length;o<v;o++){var y=B[o].split(f);if(y.length==1)j+=a(y[0]);else{j=j;var C=y[0];if(/^=/.test(C))C=w[1]+C.substring(1).replace(/[\s;]*$/,"")+w[2];var G=C;G=G.replace(/\/\*.*?\*\/|'[^']*'|"[^"]*"|\.[\$\w]+/g,"");G=G.split(/[^\$\w\d]+/);for(var H=0,I=G.length;H<I;H++){var F=G[H];if(!(!F||A[F]||/^\d/.test(F)))if(!m[F]){l+=F==="print"?w[4]:
F+'=$data.hasOwnProperty("'+F+'")?$data.'+F+":window."+F+",";m[F]=1}}j=j+(C+"\n");j+=y[1]?a(y[1]):""}}return new Function("$data",l+w[0]+j+"return "+w[3])}function a(B){B=B.replace(/('|"|\\)/g,"\\$1").replace(/\r/g,"\\r").replace(/\n/g,"\\n");B=w[1]+'"'+B+'"'+w[2];return B+"\n"}for(var b="<%",f="%>",e="$return",l="var ",m,w="".trim?[e+' = "";',e+" +=",";",e+";","print=function(){"+e+'+=[].join.call(arguments,"")},']:[e+" = [];",e+".push(",")",e+'.join("");',"print=function(){"+e+".push.apply(arguments)},"],
...
"")};u=function(c,a){return encodeURIComponent(String(c))+"="+encodeURIComponent(String(a))};k=function(c,a){a=a||2;return c.replace(/[^\x00-\xff]/g,{2:"aa",3:"aaa"}[a]).length};d=function(c,a){return c.substring(0,c.length-a)};n=function(c){return c.replace(/[&'"<>\/\\\-\x00-\x09\x0b-\x0c\x1f\x80-\xff]/g,function(a){return"&#"+a.charCodeAt(0)+";"}).replace(/ /g,"&nbsp;").replace(/\r\n/g,"<br />").replace(/\n/g,"<br />").replace(/\r/g,"<br />")};q=function(c){return escape(c).replace(/\+/g,"%2B")};
...
l){if(e.stack)return e.stack;else if(e.message.indexOf("\nBacktrace:\n")>=0){var m=0;return e.message.split("\nBacktrace:\n")[1].replace(/\s*\n\s*/g,function(){m++;return m%2==0?"\n":" @ "})}else{for(var w=l.callee==q?l.callee.caller:l.callee,z=w.arguments,A=[],x=0,E=z.length;x<E;x++)A.push(typeof z[x]=="undefined"?"<u>":z[x]===null?"<n>":z[x]);z=/function\s+([^\s\(]+)\(/;return((z.test(w.toString())?z.exec(w.toString())[1]:"<ANON>")+"("+A.join()+");").replace(/\n/g,"")}}var b;if(g instanceof Error&&
...
h?h.toString().split("."):["0"],r=p?p.split("."):[""],s="",u=t[0],k=r[0],d=u.length-1,n=false,q=k.length-1;q>=0;q--)switch(k.substr(q,1)){case "":if(d>=0)s=u.substr(d--,1)+s;break;case "0":s=d>=0?u.substr(d--,1)+s:"0"+s;break;case ",":n=true;s=","+s}if(d>=0)if(n)for(k=u.length;d>=0;d--){s=u.substr(d,1)+s;if(d>0&&(k-d)%3==0)s=","+s}else s=u.substr(0,d+1)+s;s+=".";u=t.length>1?t[1]:"";k=r.length>1?r[1]:"";for(q=d=0;q<k.length;q++)switch(k.substr(q,1)){case "":if(d<u.length)s+=u.substr(d++,1);break;
...
Jx().$package(function(i){var h=i.event,p={"#":"id",".":"className","@":"el","!":"!"},t={blur:1,focus:1,change:1};i.event.eventProxy=function(r,s){var u={},k,d;for(k in s){d=s[k];var n=k.split(" "),q=n[0];n=n[1];u[n]=u[n]||[];u[n].push([q,d])}k=d=null;for(k in u){d=u[k];if(t[k]||k.charAt(0)=="@")for(n=d.length-1;n>=0;n--){q=d[n][0].split(",");for(var g=q.length-1;g>=0;g--){var c=p[q[g].charAt(0)];if(c=="id")h.on($D.id(q[g].substr(1)),k,d[n][1]);else c=="el"&&h.on(r,k.substr(1),d[n][1])}}else h.on(r,
...
else{this.onBeater(1);this.onLoop();if(b.loop<=0||--this.loop)this.time=a;else{this.stopTimer();this.onEnd()}}},stopTimer:function(){if(!this.timer)return false;this.time=i.now()-this.time;this.timer=n(this);return true},startTimer:function(){if(this.timer)return false;this.time=i.now()-this.time;this.timer=d(this);return true}}),u={},k={},d=function(a){var b=a.option.fps,f=u[b]||(u[b]=[]);f.push(a);k[b]||(k[b]=setInterval(function(){for(var e=f.length;e--;)f[e]&&f[e].update()},Math.round(1E3/b)));
return true},n=function(a){var b=a.option.fps,f=u[b]||[];i.array.remove(f,a);if(!f.length&&k[b])k[b]=clearInterval(k[b]);return false},q=new i.Class({extend:s},{init:function(a){q.superClass.init.apply(this,arguments);this.option=this.option||{};a=i.extend(this.option,{element:null,property:"",from:0,to:1,unit:false,transition:r.linear,fps:25,converter:g},a);this.from=a.from;this.to=a.to},getTransition:function(){return this.option.transition||r.sinusoidal.easeInOut},set:function(a){var b=this.option;
...
Jx().$package(function(i){var h=window.JSON||{};(function(){function p(q){s.lastIndex=0;return s.test(q)?'"'+q.replace(s,function(g){var c=d[g];return typeof c==="string"?c:"\\u"+("0000"+g.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+q+'"'}function t(q,g){var c,a,b,f,e=u,l,m=g[q];if(m&&typeof m==="object"&&typeof m.toJSON==="function")m=m.toJSON(q);if(typeof n==="function")m=n.call(g,q,m);switch(typeof m){case "string":return p(m);case "number":return isFinite(m)?String(m):"null";case "boolean":case "null":return String(m);
case "object":if(!m)return"null";u+=k;l=[];if(Object.prototype.toString.apply(m)==="[object Array]"){f=m.length;for(c=0;c<f;c+=1)l[c]=t(c,m)||"null";b=l.length===0?"[]":u?"[\n"+u+l.join(",\n"+u)+"\n"+e+"]":"["+l.join(",")+"]";u=e;return b}if(n&&typeof n==="object"){f=n.length;for(c=0;c<f;c+=1){a=n[c];if(typeof a==="string")if(b=t(a,m))l.push(p(a)+(u?": ":":")+b)}}else for(a in m)if(Object.hasOwnProperty.call(m,a))if(b=t(a,m))l.push(p(a)+(u?": ":":")+b);b=l.length===0?"{}":u?"{\n"+u+l.join(",\n"+u)+
"\n"+e+"}":"{"+l.join(",")+"}";u=e;return b}}var r=/[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,s=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,u,k,d={"\u0008":"\\b","\t":"\\t","\n":"\\n","\u000c":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},n;if(typeof h.stringify!=="function")h.stringify=function(q,g,c){var a;k=u="";if(typeof c==="number")for(a=0;a<c;a+=1)k+=" ";
else if(typeof c==="string")k=c;if((n=g)&&typeof g!=="function"&&(typeof g!=="object"||typeof g.length!=="number"))throw Error("JSON.stringify");return t("",{"":q})};if(typeof h.parse!=="function")h.parse=function(q,g){function c(b,f){var e,l,m=b[f];if(m&&typeof m==="object")for(e in m)if(Object.hasOwnProperty.call(m,e)){l=c(m,e);if(l!==undefined)m[e]=l;else delete m[e]}return g.call(b,f,m)}var a;r.lastIndex=0;if(r.test(q))q=q.replace(r,function(b){return"\\u"+("0000"+b.charCodeAt(0).toString(16)).slice(-4)});
...
Jx().$package(function(i){var h=i.dom.id,p=i.dom,t=i.event,r;if(typeof window.XMLHttpRequest==="undefined")window.XMLHttpRequest=function(){return new window.ActiveXObject(navigator.userAgent.indexOf("MSIE 5")>=0?"Microsoft.XMLHTTP":"Msxml2.XMLHTTP")};i.http=i.http||{};r=function(k,d,n){var q,g,c,a,b=document.getElementsByTagName("head")?document.getElementsByTagName("head")[0]:document.documentElement,f,e=false,l=false;n=n||{};var m=n.isDefer||false;g=n.query||null;arguments=n.arguments||null;var w=
...
"defer");return v};if(k==="script")q=n.node||c(d,j,B,m);else if(k==="css")q=n.node||g(d,j,B);if(i.browser.engine.trident&&parseInt(i.browser.ie)<9)q.onreadystatechange=function(){var v=this.readyState;if(v==="loaded"||v==="complete"){q.onreadystatechange=null;if(!e){l=true;window.clearTimeout(f);f=null;o={};o.id=a;o.uri=d;o.arguments=arguments;w(o);A(o)}}};else if(i.browser.engine.webkit)t.on(q,"load",function(){var v;if(!e){l=true;window.clearTimeout(f);f=null;v={};v.id=a;v.uri=d;v.arguments=arguments;
w(v);A(v);k==="script"&&x(a)}});else{q.onload=function(){var v;if(!e){l=true;window.clearTimeout(f);f=null;v={};v.id=a;v.uri=d;v.arguments=n.arguments;w(v);A(v);k==="script"&&x(a)}};q.onerror=function(v){var y;if(!e){l=true;window.clearTimeout(f);f=null;y={};y.id=a;y.uri=d;y.arguments=arguments;y.error=v;z(y);A(y);x(a)}}}if(n.node)if(k==="script")q.src=d;else{if(k==="css")q.href=d}else b.appendChild(q);if(k==="script")if(D)f=window.setTimeout(function(){var v;if(!l){e=true;v={};v.uri=d;v.arguments=
arguments;E(v);A(v);x(a)}},D);m=function(v){this._node=v;this._head=b};m.prototype={abort:function(){this._node.src="";this._head.removeChild(this._node);delete this._node}};return new m(q)};r.Id=0;var s,u={_iframes:[],_tick:0,_select:function(){this._tick++;return this._iframes[(this._tick-1)%this._len]},init:function(k){if(this._isInit!=true){this._len=k;for(var d=document.body,n=0;n<k;n++){s=p.node("div",{"class":"RPCService_hDiv"});p.hide(s);s.innerHTML='<iframe id="RPCService_hIframe_'+n+'" name="RPCService_hIframe_'+
n+'" src="'+alloy.CONST.MAIN_URL+'domain.html"></iframe>';d.appendChild(s);this._iframes[n]=[s,null,"RPCService_hIframe_"+n]}this._isInit=true}},take:function(k){var d=this._select();d[1]&&d[0].removeChild(d[1]);k.setAttribute("target",d[2]);d[1]=k;d[0].appendChild(k)}};i.http.ajax=function(k,d){var n,q,g,c=false,a=false;d={method:(d.method||"GET").toUpperCase(),data:d.data||null,arguments:d.arguments||null,onSuccess:d.onSuccess||function(){},onError:d.onError||function(){},onComplete:d.onComplete||
function(){},onTimeout:d.onTimeout||function(){},isAsync:d.isAsync||true,timeout:d.timeout||3E4,contentType:d.contentType,type:d.type||"xml"};if(d.data&&typeof d.data==="object")d.data=i.string.toQueryString(d.data);k=k||"";g=d.timeout;n=new window.XMLHttpRequest;q=function(b){try{return!b.status&&location.protocol=="file:"||b.status>=200&&b.status<300||b.status==304||navigator.userAgent.indexOf("Safari")>-1&&typeof b.status=="undefined"}catch(f){}return false};n.onreadystatechange=function(){if(n.readyState==
4){if(!c){var b={};b.responseText=n.responseText;b.responseXML=n.responseXML;b.data=d.data;b.status=n.status;b.uri=k;b.arguments=d.arguments;if(d.type==="json")try{b.responseJSON=i.json.parse(n.responseText)}catch(f){}q(n)?d.onSuccess(b):d.onError(b);d.onComplete(b)}a=true;n=null}};if(d.method==="GET"){if(d.data){k+=(k.indexOf("?")>-1?"&":"?")+d.data;d.data=null}n.open("GET",k,d.isAsync);n.setRequestHeader("Content-Type",d.contentType||"text/plain;charset=UTF-8");n.send()}else if(d.method==="POST"){n.open("POST",
k,d.isAsync);n.setRequestHeader("Content-Type",d.contentType||"application/x-www-form-urlencoded;charset=UTF-8");n.send(d.data)}else{n.open(d.method,k,d.isAsync);n.send()}window.setTimeout(function(){var b;if(!a){c=true;b={};b.uri=k;b.arguments=d.arguments;d.onTimeout(b);d.onComplete(b)}},g);return n};i.http.comet=void 0;i.http.load=r;i.http.loadCss=function(k,d){return r("css",k,d)};i.http.loadScript=function(k,d){return r("script",k,d)};i.http.formSend=function(k,d){u.init(2);var n={method:d.method||
"GET",enctype:d.enctype||"",data:d.data||{},onSuccess:d.onSuccess||function(){},onError:d.onError||function(){},onComplete:d.onComplete||function(){},onTimeout:d.onTimeout||function(){},timeout:d.timeout?d.timeout:1E4},q=p.node("form",{"class":"RPCService_form",method:n.method,action:k+"?t="+(new Date).getTime(),enctype:n.enctype});if(Object.prototype.toString.call(n.data).indexOf("String")>-1){var g=p.node("input");g.type="text";g.name=n.data;q.appendChild(g)}else for(var c in n.data){g=p.node("input");
g.type="text";g.name=c;g.setAttribute("value",n.data[c]);q.appendChild(g)}u.take(q);q.submit()}});
Jx().$package(function(i){var h=function(){function p(g,c){c=c||document;if(!/^[\w\-_#]+$/.test(g)&&c.querySelectorAll)return t(c.querySelectorAll(g));if(g.indexOf(",")>-1){for(var a=g.split(/,/g),b=[],f=0,e=a.length;f<e;++f)b=b.concat(p(a[f],c));return q(b)}a=g.match(s);f=a.pop();b=(f.match(k)||n)[1];e=!b&&(f.match(u)||n)[1];f=!b&&(f.match(d)||n)[1];if(e&&!f&&c.getElementsByClassName)f=t(c.getElementsByClassName(e));else{f=!b&&t(c.getElementsByTagName(f||"*"));if(e){f=f;e=RegExp("(^|\\s)"+e+"(\\s|$)");
for(var l=-1,m,w=-1,z=[];m=f[++l];)if(e.test(m.className))z[++w]=m;f=z}if(b)return(a=c.getElementById(b))?[a]:[]}return a[0]&&f[0]?r(a,f):f}function t(g){try{return Array.prototype.slice.call(g)}catch(c){for(var a=[],b=0,f=g.length;b<f;++b)a[b]=g[b];return a}}function r(g,c,a){var b=g.pop();if(b===">")return r(g,c,true);var f=[],e=-1,l=(b.match(k)||n)[1],m=!l&&(b.match(u)||n)[1];b=!l&&(b.match(d)||n)[1];var w=-1,z,A,x;for(b=b&&b.toLowerCase();z=c[++w];){A=z.parentNode;do{x=(x=(x=!b||b==="*"||b===
A.nodeName.toLowerCase())&&(!l||A.id===l))&&(!m||RegExp("(^|\\s)"+m+"(\\s|$)").test(A.className));if(a||x)break}while(A=A.parentNode);if(x)f[++e]=z}return g[0]&&f[0]?r(g,f):f}var s=/(?:[\w\-\\.#]+)+(?:\[\w+?=([\'"])?(?:\\\1|.)+?\1\])?|\*|>/ig,u=/^(?:[\w\-_]+)?\.([\w\-_]+)/,k=/^(?:[\w\-_]+)?#([\w\-_]+)/,d=/^([\w\*\-_]+)/,n=[null,null],q=function(){var g=+new Date,c=function(){var a=1;return function(b){var f=b[g],e=a++;if(!f){b[g]=e;return true}return false}}();return function(a){for(var b=a.length,
f=[],e=-1,l=0,m;l<b;++l){m=a[l];if(c(m))f[++e]=m}g+=1;return f}}();return p}();i.dom.mini=h});Jx().$package(function(i){i.number=i.number||{};i.number.format=i.format.number});
