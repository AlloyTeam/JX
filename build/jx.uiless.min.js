(function(i){var h=i.Jx,p={},t={},r={NO_DEBUG:0,SHOW_ALL:1},s={debug:1},u=function(d,n,q){d=String(d);if(s.debug)if(this.console)this.console.out?this.console.out(d,n,q):alert(d+" - \u6d88\u606f\u7c7b\u578b["+q+"]");return d};try{if(typeof h==="undefined"||h.mark&&h.mark==="JxMark"){if(h){p=h.VERSIONS;t=h.PACKAGES}h=function(d,n){var q=this;if(n)if(q&&q.hasOwnProperty&&q instanceof h)q._init();else q=new h(d);else if(d){d=String(d);try{if(h.VERSIONS[d])q=h.VERSIONS[d];else{q=h.VERSIONS[h.DEFAULT_VERSION];
throw Error("\u6ca1\u6709\u627e\u5230 JET version "+d+", \u6240\u4ee5\u8fd4\u56de\u9ed8\u8ba4\u7248\u672c JET version "+h.DEFAULT_VERSION+"!");}}catch(g){q.out("A.\u9519\u8bef\uff1a["+g.name+"] "+g.message+", "+g.fileName+", \u884c\u53f7:"+g.lineNumber+"; stack:"+typeof g.stack,2)}}else q=h.VERSIONS[h.DEFAULT_VERSION];return q};h.prototype={version:"1.0.%Version%",DEBUG:r,option:s,_init:function(){this.constructor=h},$namespace:function(d){if(!d)return i;d=String(d);var n,q=d.split("."),g=i;for(d=
0;d<q.length;d+=1){n=q[d];g[n]=g[n]||{};g=g[q[d]]}return g},$package:function(){var d=arguments[0],n=arguments[arguments.length-1],q=i,g;if(typeof n==="function"){if(typeof d==="string"){q=this.$namespace(d);h.PACKAGES[d]||(h.PACKAGES[d]={isLoaded:true,returnValue:g});q.packageName=d}else if(typeof d==="object")q=d;g=n.call(q,this);typeof d==="string"&&(h.PACKAGES[d].returnValue=g)}else throw Error("Function required");},checkPackage:function(d){return h.PACKAGES[d]},out:u,debug:function(){},profile:function(){},
warn:function(){},error:function(){},startTime:+new Date,about:function(){return this.out("JET (Javascript Extend Tools)\nversion: "+this.version+"\n\nCopyright (c) 2009, All rights reserved.")},toString:function(){return"JET version "+this.version+" !"}};h.VERSIONS=p;h.PACKAGES=t;h.VERSIONS["1.0.%Version%"]=new h("1.0.%Version%",true);h.DEFAULT_VERSION="1.0.%Version%";h.mark="JxMark";i.Jet=i.Jx=h}else throw Error('"Jx" name is defined in other javascript code !!!');}catch(l){u("JET \u5fae\u5185\u6838\u521d\u59cb\u5316\u5931\u8d25! B.\u9519\u8bef\uff1a["+
l.name+"] "+l.message+", "+l.fileName+", \u884c\u53f7:"+l.lineNumber+"; stack:"+typeof l.stack,1)}})(this);
Jx().$package(function(i){var h,p,t,r,s,u,l,d,n,q,g;h=function(a){return typeof a==="undefined"};p=function(a){return a===null};t=function(a){return(a===0||a)&&a.constructor===Number};s=function(a){return(a===false||a)&&a.constructor===Boolean};r=function(a){return(a===""||a)&&a.constructor===String};u=function(a){return a&&(a.constructor===Object||Object.prototype.toString.call(a)==="[object Object]")};l=function(a){return a&&(a.constructor===Array||Object.prototype.toString.call(a)==="[object Array]")};
d=function(a){return a&&a.callee&&t(a.length)?true:false};n=function(a){return a&&a.constructor===Function};q=function(a){var b=arguments,f,e;if(b.length===1){a=this;b=0}else{a=b[0]||{};b=1}for(;b<arguments.length;b++){e=arguments[b];for(f in e){var k=a[f],m=e[f];if(k!==m)if(m&&u(m)&&!l(m)&&!m.nodeType&&!n(m)){k=a[f]||{};a[f]=q(k,m||(m.length!=null?[]:{}))}else if(m!==undefined)a[f]=m}}return a};g=function(){var a=arguments.length,b=arguments[a-1];b.init=b.init||function(){};if(a===2){a=arguments[0].extend;
var f=function(){};f.prototype=a.prototype;var e=function(){this.init.apply(this,arguments)};e.superClass=a.prototype;e.callSuper=function(k,m){var w=Array.prototype.slice,z=w.call(arguments,2);(m=e.superClass[m])&&m.apply(k,z.concat(w.call(arguments)))};e.prototype=new f;e.prototype.constructor=e;i.extend(e.prototype,b);e.prototype.init=function(){b.init.apply(this,arguments)};return e}else if(a===1){a=function(){return this.init.apply(this,arguments)};a.prototype=b;return a}};var c=new g({init:function(a,
b,f,e,k){var m=a.concat();if(e)m=a;this.timeout=window.setTimeout(function(){var w=+new Date;do b.call(f,m.shift());while(m.length>0&&+new Date-w<50);if(m.length>0)this.timeout=window.setTimeout(arguments.callee,25);else k&&k(a)},25)},stop:function(){clearTimeout(this.timeout)}});i.isUndefined=h;i.isNull=p;i.isNumber=t;i.isString=r;i.isBoolean=s;i.isObject=u;i.isArray=l;i.isArguments=d;i.isFunction=n;i.$typeof=function(a){return h(a)?"undefined":p(a)?"null":t(a)?"number":s(a)?"boolean":r(a)?"string":
u(a)?"object":l(a)?"array":d(a)?"arguments":n(a)?"function":"other"};i.$return=function(a){return i.isFunction(a)?a:function(){return a}};i.$try=function(){var a,b=arguments.length,f;for(a=0;a<b;a++)try{f=arguments[a]();break}catch(e){i.out("C.\u9519\u8bef\uff1a["+e.name+"] "+e.message+", "+e.fileName+", \u884c\u53f7:"+e.lineNumber+"; stack:"+typeof e.stack,2)}return f};i.emptyFunc=function(){};i.clone=function(a){var b=function(){};b.prototype=a;return new b};i.getLength=function(a){var b,f=0;for(b in a)a.hasOwnProperty(b)&&
f++;return f};i.checkJSON=function(){return true};i.random=function(a,b){return Math.floor(Math.random()*(b-a+1)+a)};i.extend=q;i.now=function(){return+new Date};i.timedChunk=function(a,b,f,e,k){var m=a.concat();if(e)m=a;window.setTimeout(function(){var w=+new Date;do b.call(f,m.shift());while(m.length>0&&+new Date-w<50);if(m.length>0)window.setTimeout(arguments.callee,25);else k&&k(a)},25)};i.rebuild=function(a,b){b=b||{};a.$$rebuildedFunc=a.$$rebuildedFunc||function(){var f,e;f=b.contextObj||this;
...
Jx().$package(function(i){i.array=i.array||{};var h=i.array,p,t,r,s,u,l,d,n,q,g,c,a;p=Array.prototype.indexOf?function(){var b=Array.prototype.slice.call(arguments,1);return Array.prototype.indexOf.apply(arguments[0],b)}:function(b,f,e){if(e==null)e=0;else if(e<0)e=Math.max(0,b.length+e);for(e=e;e<b.length;e++)if(b[e]===f)return e;return-1};t=Array.prototype.lastIndexOf?function(){var b=Array.prototype.slice.call(arguments,1);return Array.prototype.lastIndexOf.apply(arguments[0],b)}:function(b,f,
e){if(e==null)e=b.length-1;else if(e<0)e=Math.max(0,b.length+e);for(e=e;e>=0;e--)if(b[e]===f)return e;return-1};r=Array.prototype.forEach?function(){var b=Array.prototype.slice.call(arguments,1);return Array.prototype.forEach.apply(arguments[0],b)}:function(b,f,e){var k=b.length;if(typeof f!="function")throw new TypeError;for(var m=0;m<k;m++)m in b&&f.call(e,b[m],m,b)};s=Array.prototype.filter?function(){var b=Array.prototype.slice.call(arguments,1);return Array.prototype.filter.apply(arguments[0],
b)}:function(b,f,e){var k=b.length;if(typeof f!="function")throw new TypeError;for(var m=[],w=0;w<k;w++)if(w in b){var z=b[w];f.call(e,z,w,b)&&m.push(z)}return m};u=Array.prototype.some?function(){var b=Array.prototype.slice.call(arguments,1);return Array.prototype.some.apply(arguments[0],b)}:function(b,f,e){var k=b.length;if(typeof f!="function")throw new TypeError;for(var m=0;m<k;m++)if(m in b&&f.call(e,b[m],m,b))return true;return false};l=Array.prototype.map?function(){var b=Array.prototype.slice.call(arguments,
1);return Array.prototype.map.apply(arguments[0],b)}:function(b,f,e){var k=b.length;if(typeof f!="function")throw new TypeError;for(var m=Array(k),w=0;w<k;w++)if(w in b)m[w]=f.call(e,b[w],w,b);return m};d=Array.prototype.every?function(){var b=Array.prototype.slice.call(arguments,1);return Array.prototype.every.apply(arguments[0],b)}:function(b,f,e){var k=b.length;if(typeof f!="function")throw new TypeError;for(var m=0;m<k;m++)if(m in b&&!f.call(e,b[m],m,b))return false;return true};n=Array.prototype.reduce?
function(){var b=Array.prototype.slice.call(arguments,1);return Array.prototype.reduce.apply(arguments[0],b)}:function(b,f){var e=b.length>>>0;if(typeof f!="function")throw new TypeError;if(e==0&&arguments.length==2)throw new TypeError;var k=0;if(arguments.length>=3)var m=arguments[2];else{do{if(k in b){m=b[k++];break}if(++k>=e)throw new TypeError;}while(1)}for(;k<e;k++)if(k in b)m=f.call(null,m,b[k],k,b);return m};q=Array.prototype.reduceRight?function(){var b=Array.prototype.slice.call(arguments,
1);return Array.prototype.reduceRight.apply(arguments[0],b)}:function(b,f){var e=b.length>>>0;if(typeof f!="function")throw new TypeError;if(e==0&&arguments.length==2)throw new TypeError;e=e-1;if(arguments.length>=3)var k=arguments[2];else{do{if(e in b){k=b[e--];break}if(--e<0)throw new TypeError;}while(1)}for(;e>=0;e--)if(e in b)k=f.call(null,k,b[e],e,b);return k};g=function(b){var f=i.$typeof(b);return f?f!="array"&&f!="arguments"?[b]:b:[]};c=function(b,f){return p(b,f)>-1};a=function(b){for(var f=
[],e=0,k=b.length;e<k;e++)c(f,b[e])||f.push(b[e]);return f};h.indexOf=p;h.lastIndexOf=t;h.forEach=r;h.filter=s;h.some=u;h.map=l;h.every=d;h.reduce=n;h.reduceRight=q;h.toArray=g;h.remove=function(b,f){f=g(f);var e,k,m=false;for(e=0;e<f.length;e++)for(k=0;k<b.length;k++)if(b[k]===f[e]){b.splice(k,1);m=true}return m};h.replace=function(b,f,e){var k;for(k=0;k<b.length;k++)if(b[k]===f){b[k]=e;return true}return false};h.bubbleSort=function(b,f){f=f||function(A,x){return A-x};for(var e=b.length,k,m,w=0;w<
e-1;w++){m=false;for(var z=e-1;z>w;z--)if(f(b[z],b[z-1])<0){m=true;k=b[z-1];b[z-1]=b[z];b[z]=k}if(!m)break}return b};h.binarySearch=function(b,f,e){for(var k=0,m=b.length,w=Math.floor(b.length/2);m!=w;){if(e(f,b[w])>0)k=w+1;else m=w;w=Math.floor((k+m)/2)}return w};h.contains=c;h.uniquelize=a;h.intersect=function(b,f){for(var e=[],k=0,m=b.length;k<m;k++)c(f,b[k])&&e.push(b[k]);return e};h.minus=function(b,f){for(var e=[],k=0,m=b.length;k<m;k++)c(f,b[k])||e.push(b[k]);return e};h.union=function(b,f){return a(b.concat(f))}});
Jx().$package(function(i){i.browserOptions={adjustBehaviors:true,htmlClass:true};i.host=window.location.host;var h=navigator.platform.toLowerCase(),p=navigator.userAgent.toLowerCase(),t=navigator.plugins,r,s,u,l,d;l=function(g,c){g=(""+g).replace(/_/g,".");c=c||1;g=String(g).split(".");g=g[0]+"."+(g[1]||"0");return g=Number(g).toFixed(c)};r={getPlatform:function(){return h},name:window.orientation!=undefined?"iPod":(h.match(/mac|win|linux/i)||["unknown"])[0],version:0,iPod:0,iPad:0,iPhone:0,android:0,
win:0,linux:0,mac:0,set:function(g,c){this.name=g;this.version=c;this[g]=c}};r[r.name]=true;(d=p.match(/windows ([\d.]+)/))?r.set("win",l(d[1])):(d=p.match(/windows nt ([\d.]+)/))?r.set("win",l(d[1])):(d=p.match(/linux ([\d.]+)/))?r.set("linux",l(d[1])):(d=p.match(/mac ([\d.]+)/))?r.set("mac",l(d[1])):(d=p.match(/ipod ([\d.]+)/))?r.set("iPod",l(d[1])):(d=p.match(/ipad[\D]*os ([\d_]+)/))?r.set("iPad",l(d[1])):(d=p.match(/iphone ([\d.]+)/))?r.set("iPhone",l(d[1])):(d=p.match(/android ([\d.]+)/))&&r.set("android",
l(d[1]));s={features:{xpath:!!document.evaluate,air:!!window.runtime,query:!!document.querySelector},getPlugins:function(){return t},plugins:{flash:function(){var g=0;if(t&&t.length){var c=t["Shockwave Flash"];if(c&&c.description)g=l(c.description.match(/\b(\d+)\.\d+\b/)[1],1)||g}else for(c=13;c--;)try{new ActiveXObject("ShockwaveFlash.ShockwaveFlash."+c);g=l(c);break}catch(a){}return g}()},getUserAgent:function(){return p},name:"unknown",version:0,ie:0,firefox:0,chrome:0,opera:0,safari:0,mobileSafari:0,
adobeAir:0,set:function(g,c){this.name=g;this.version=c;this[g]=c}};(d=p.match(/msie ([\d.]+)/))?s.set("ie",l(d[1])):(d=p.match(/firefox\/([\d.]+)/))?s.set("firefox",l(d[1])):(d=p.match(/chrome\/([\d.]+)/))?s.set("chrome",l(d[1])):(d=p.match(/opera.([\d.]+)/))?s.set("opera",l(d[1])):(d=p.match(/adobeair\/([\d.]+)/))?s.set("adobeAir",l(d[1])):(d=p.match(/version\/([\d.]+).*safari/))&&s.set("safari",l(d[1]));(d=p.match(/version\/([\d.]+).*mobile.*safari/))&&s.set("mobileSafari",l(d[1]));r.iPad&&s.set("mobileSafari",
"0.0");if(s.ie)if(document.documentMode)document.documentMode!==Math.floor(s.ie)&&s.set("ie",l(document.documentMode));else document.documentMode=Math.floor(s.ie);u={name:"unknown",version:0,trident:0,gecko:0,webkit:0,presto:0,set:function(g,c){this.name=g;this.version=c;this[g]=c}};(d=p.match(/trident\/([\d.]+)/))?u.set("trident",l(d[1])):(d=p.match(/gecko\/([\d.]+)/))?u.set("gecko",l(d[1])):(d=p.match(/applewebkit\/([\d.]+)/))?u.set("webkit",l(d[1])):(d=p.match(/presto\/([\d.]+)/))&&u.set("presto",
l(d[1]));if(s.ie)if(s.ie==6)u.set("trident",l("4"));else if(s.ie==7||s.ie==8)u.set("trident",l("5"));if(i.browserOptions.adjustBehaviors)if(s.ie&&s.ie<7)try{document.execCommand("BackgroundImageCache",false,true)}catch(n){}var q=function(g){return String(g).replace(/\./gi,"_")};d=function(){var g=document.documentElement,c=[g.className];c.push("javascriptEnabled");c.push(r.name);c.push(r.name+q(r.version));c.push(s.name);c.push(s.name+q(s.version));document.documentMode&&c.push("documentMode_"+document.documentMode);
...
j)return o[v]})();a=function(j){var o=0,v=0;if(j)if(document.documentElement.getBoundingClientRect&&j.getBoundingClientRect){v={left:0,top:0,right:0,bottom:0};try{v=j.getBoundingClientRect()}catch(y){return[0,0]}j=j.ownerDocument;var C=i.browser.ie?2:0;o=v.top-C+c(j);v=v.left-C+g(j)}else for(;j.offsetParent;){o+=j.offsetTop;v+=j.offsetLeft;j=j.offsetParent}return[v,o]};b=function(j){j=a(j);j[0]+=g();j[1]+=c();return j};f=function(j,o,v){var y=parseInt(n(j,"marginLeft"))||0,C=parseInt(n(j,"marginTop"))||
...
function(j){return j.className};h.hasClass=r;h.addClass=s;h.removeClass=u;h.toggleClass=l;h.replaceClass=function(j,o,v){u(j,o);s(j,v)};h.createStyleNode=function(j,o){var v=h.node("style",{id:o||"",type:"text/css"});h.getDocHead().appendChild(v);var y=typeof j;if(y=="string")if(v.styleSheet)v.styleSheet.cssText=j;else{y=document.createTextNode(j);v.appendChild(y)}else if(y=="object"){y=0;var C=document.styleSheets[document.styleSheets.length-1];for(selector in j)C.insertRule?C.insertRule(selector+
"{"+j[selector]+"}",y++):C.addRule(selector,j[selector],y++)}return v};h.setStyle=d;h.getStyle=n;h.setCssText=q;h.getCssText=function(j){return j.style.cssText};h.addCssText=function(j,o){j.style.cssText+=";"+o};h.show=function(j,o){var v;v=(v=j.getAttribute("_oldDisplay"))?v:n(j,"display");if(o)d(j,"display",o);else v==="none"?d(j,"display","block"):d(j,"display",v)};h.isShow=function(j){return n(j,"display")==="none"?false:true};h.recover=function(j){var o;o=(o=j.getAttribute("_oldDisplay"))?o:
n(j,"display");o==="none"?d(j,"display",""):d(j,"display",o)};h.hide=function(j){var o=n(j,"display");j.getAttribute("_oldDisplay")||(o==="none"?j.setAttribute("_oldDisplay",""):j.setAttribute("_oldDisplay",o));d(j,"display","none")};h.getScrollLeft=g;h.getScrollTop=c;h.getScrollHeight=function(j){return(j?j.scrollHeight:Math.max(document.documentElement.scrollHeight,document.body.scrollHeight))||0};h.getScrollWidth=function(j){return(j?j.scrollWidth:Math.max(document.documentElement.scrollWidth,
...
Jx().$package(function(i){var h,p,t,r,s,u,l=[],d,n,q,g,c;i.event=i.event||{};h=i.event;c=function(a,b){if(!a)a=window.event;b=b||a.srcElement;var f=document,e=f.documentElement;f=f.body;e={_event:a,type:a.type,target:a.srcElement,currentTarget:b,relatedTarget:a.fromElement?a.fromElement:a.toElement,eventPhase:a.srcElement==b?2:3,clientX:a.clientX,clientY:a.clientY,screenX:a.screenX,screenY:a.screenY,layerX:a.offsetX,layerY:a.offsetY,pageX:a.clientX+(e&&e.scrollLeft||f&&f.scrollLeft||0)-(e&&e.clientLeft||
f&&f.clientLeft||0),pageY:a.clientY+(e&&e.scrollTop||f&&f.scrollTop||0)-(e&&e.clientTop||f&&f.clientTop||0),wheelDelta:a.wheelDelta,altKey:a.altKey,ctrlKey:a.ctrlKey,shiftKey:a.shiftKey,charCode:a.keyCode,keyCode:a.keyCode,stopPropagation:function(){this._event.cancelBubble=true},preventDefault:function(){this._event.returnValue=false}};f=a.type.toLowerCase();if(f=="mouseover")e.relatedTarget=a.fromElement;else if(f=="mouseout")e.relatedTarget=a.toElement;if(!i.isUndefined(a.button)){f=a.button;var k=
{0:-1,1:0,2:2,3:-1,4:1};e.button=i.isUndefined(k[f])?f:k[f]}return e};if(document.addEventListener){p=function(a,b,f,e){u["on"+b]?u["on"+b](a,b,f,e):t(a,b,f)};t=function(a,b,f){var e=false;a||i.out("targetModel undefined:"+b+f);if(!a._eventTypes)a._eventTypes={};a._eventTypes[b]||(a._eventTypes[b]=[]);a.addEventListener(b,f,false);a=a._eventTypes[b];for(b=0;b<a.length;b++)if(a[b]==f){e=true;break}e||a.push(f)};r=function(a,b,f){if(u["off"+b])u["off"+b](a,b,f);else arguments.length==3?s(a,b,f):s(a,
b)};s=function(a,b,f){if(b)if(arguments.length==3){if(f){a.removeEventListener(b,f,false);if(a._eventTypes&&a._eventTypes[b])for(var e=a._eventTypes[b],k=0;k<e.length;k++)if(e[k]===f){e[k]=null;e.splice(k,1);break}}}else{if(a._eventTypes&&a._eventTypes[b]){e=a._eventTypes[b];for(k=0;k<e.length;k++)a.removeEventListener(b,e[k],false);a._eventTypes[b]=[]}}else if(a._eventTypes){var m=a._eventTypes,w;for(w in m){e=a._eventTypes[w];for(k=0;k<e.length;k++)a.removeEventListener(w,e[k],false)}}}}else if(document.attachEvent){p=
function(a,b,f,e){u["on"+b]?u["on"+b](a,b,f,e):t(a,b,f)};t=function(a,b,f){if(h._find(arguments)==-1){var e=function(w){w=c(w,a);if(Function.prototype.call)f.call(a,w);else{a._currentHandler=f;a._currentHandler(w);a._currentHandler=null}};a.attachEvent("on"+b,e);e={element:a,eventType:b,handler:f,wrappedEvent:e};var k=(a.document||a).parentWindow||window,m=h._uid();if(!k._allHandlers)k._allHandlers={};k._allHandlers[m]=e;if(!a._handlers)a._handlers=[];a._handlers.push(m);if(!k._onunloadEventRegistered){k._onunloadEventRegistered=
true;k.attachEvent("onunload",h._removeAllEvents)}}};r=function(a,b,f){if(u["off"+b])u["off"+b](a,b,f);else arguments.length==3?s(a,b,f):s(a,b)};s=function(a){var b=h._find(arguments);if(b!=-1){for(var f=(a.document||a).parentWindow||window,e=0;e<b.length;e++){var k=b[e],m=a._handlers[k],w=f._allHandlers[m];a.detachEvent("on"+w.eventType,w.wrappedEvent);a._handlers[k]=null;a._handlers.splice(k,1);delete f._allHandlers[m]}if(a._handlers&&a._handlers.length==0)a._handlers=null}};h._find=function(a){var b=
a[0],f=a[1],e=a[2],k=b._handlers;if(!k)return-1;b=(b.document||b).parentWindow||window;var m=[];if(a.length===3)for(a=k.length-1;a>=0;a--){var w=k[a];w=b._allHandlers[w];if(w.eventType==f&&w.handler==e){m.push(a);return m}}else if(a.length===2){for(a=k.length-1;a>=0;a--){w=k[a];w=b._allHandlers[w];w.eventType==f&&m.push(a)}if(m.length>0)return m}else if(a.length===1){for(a=k.length-1;a>=0;a--)m.push(a);if(m.length>0)return m}return-1};h._removeAllEvents=function(){for(var a in this._allHandlers){var b=
this._allHandlers[a];b.element.detachEvent("on"+b.eventType,b.wrappedEvent);b.element._handlers=null;delete this._allHandlers[a]}};h._counter=0;h._uid=function(){return"h"+h._counter++}}u={ondrag:function(a,b,f){var e,k,m=false,w=function(x){if(!(!i.browser.mobileSafari&&x.button!==0)){if(i.browser.mobileSafari){x.stopPropagation();x=x.touches[0];e=x.pageX;k=x.pageY}else{x.stopPropagation();x.preventDefault();e=x.clientX;k=x.clientY}m=false;if(i.browser.mobileSafari){h.addEventListener(document,"touchmove",
z);h.addEventListener(a,"touchend",A)}else h.addEventListener(document,"mousemove",z)}},z=function(x){if(!(!i.browser.mobileSafari&&x.button!==0)){var E,D;x.stopPropagation();if(i.browser.mobileSafari){D=x.changedTouches[0];E=D.pageX;D=D.pageY}else{E=x.clientX;D=x.clientY}if(Math.abs(e-E)+Math.abs(k-D)>2){if(i.browser.mobileSafari){h.removeEventListener(document,"touchmove",z);h.removeEventListener(a,"touchend",A)}else h.removeEventListener(document,"mousemove",z);if(!m){f.call(a,x);m=true}}}},A=
function(x){if(!(!i.browser.mobileSafari&&x.button!==0))if(i.browser.mobileSafari){h.removeEventListener(document,"touchmove",z);if(m){x.stopPropagation();x.preventDefault()}}else h.removeEventListener(document,"mousemove",z)};if(i.browser.mobileSafari)h.addEventListener(a,"touchstart",w);else{h.addEventListener(a,"mousedown",w);h.addEventListener(a,"mouseup",A)}l.push({element:a,eventType:b,handler:f,actions:[w,A]})},offdrag:function(a,b,f){for(var e in l)if(l[e].handler==f&&l[e].element==a&&l[e].eventType==
b){if(i.browser.mobileSafari){h.removeEventListener(a,"touchstart",l[e].actions[0]);h.removeEventListener(a,"touchend",l[e].actions[1])}else{h.removeEventListener(a,"mousedown",l[e].actions[0]);h.removeEventListener(a,"mouseup",l[e].actions[1])}l.splice(e,1);break}},oncustomclick:function(a,b,f,e){var k,m,w=false,z=false,A;e=e?e:{};var x=e.longtouchable,E=-1;e=function(o){w=false;if(!(!i.browser.mobileSafari&&o.button!==0)){var v;if(i.browser.mobileSafari){v=o.changedTouches[0];k=v.pageX;m=v.pageY}else{k=
o.clientX;m=o.clientY}z=false;if(x)A=setTimeout(function(){if(!(w||z)){if(i.browser.mobileSafari){h.removeEventListener(a,"touchmove",B);h.removeOriginalEventListener(a,"touchend",j)}else{h.removeEventListener(a,"mousemove",B);h.removeOriginalEventListener(a,"click",j)}f.call(a,o,2E3)}},1E3);if(i.browser.mobileSafari){h.addEventListener(a,"touchmove",B);h.addOriginalEventListener(a,"touchend",j)}else{h.addEventListener(a,"mousemove",B);h.addOriginalEventListener(a,"click",j)}}};var D=function(o){E=
o.button;if(!(!i.browser.mobileSafari&&o.button!==0))if(i.browser.mobileSafari)touch=o.changedTouches[0]},B=function(o){if(i.browser.mobileSafari){touch=o.changedTouches[0];var v=touch.pageX;o=touch.pageY}else{v=o.clientX;o=o.clientY}if(w=Math.abs(k-v)+Math.abs(m-o)>1){clearTimeout(A);A=null;if(i.browser.mobileSafari){h.removeEventListener(a,"touchmove",B);h.removeOriginalEventListener(a,"touchend",j)}else{h.removeEventListener(a,"mousemove",B);h.removeOriginalEventListener(a,"click",j)}}},j=function(o){clearTimeout(A);
A=null;z=true;if(!(!i.browser.mobileSafari&&E!==0)){var v;if(i.browser.mobileSafari){v=o.changedTouches[0];var y=v.pageX;v=v.pageY}else{y=o.clientX;v=o.clientY}if(Math.abs(k-y)+Math.abs(m-v)<1){w=false;f.call(a,o,0)}}};if(i.browser.mobileSafari)h.addEventListener(a,"touchstart",e);else{h.addEventListener(a,"mousedown",e);h.addEventListener(a,"mouseup",D)}l.push({element:a,eventType:b,handler:f,actions:[e,B,D,j]})},offcustomclick:function(a,b,f){for(var e in l)if(l[e].handler==f&&l[e].element==a&&
l[e].eventType==b){if(i.browser.mobileSafari){h.removeEventListener(a,"touchstart",l[e].actions[0]);h.removeEventListener(a,"touchmove",l[e].actions[1]);h.removeOriginalEventListener(a,"touchend",l[e].actions[3])}else{h.removeEventListener(a,"mousedown",l[e].actions[0]);h.removeEventListener(a,"mousemove",l[e].actions[1]);h.removeEventListener(a,"mouseup",l[e].actions[2]);h.removeOriginalEventListener(a,"click",l[e].actions[3])}l.splice(e,1);break}},oncontextmenu:function(a,b,f){if(i.browser.ie==
9){var e=function(k){k=c(k,a);f.call(a,k)};a.attachEvent("oncontextmenu",e);l.push({element:a,eventType:b,handler:f,actions:[e]})}else h.addOriginalEventListener(a,b,f)},offcontextmenu:function(a,b,f){if(i.browser.ie==9)for(var e in l){if(l[e].handler==f&&l[e].element==a&&l[e].eventType==b){a.detachEvent("oncontextmenu",l[e].actions[0]);l.splice(e,1);break}}else h.removeOriginalEventListener(a,b,f)},onmousewheel:function(a,b,f){if(i.browser.firefox){var e=function(k){k.wheelDelta=-40*k.detail;f.call(a,
k)};h.addOriginalEventListener(a,"DOMMouseScroll",e);l.push({element:a,eventType:b,handler:f,actions:[e]})}else h.addOriginalEventListener(a,"mousewheel",f)},offmousewheel:function(a,b,f){if(i.browser.firefox)for(var e in l){if(l[e].handler==f&&l[e].element==a&&l[e].eventType==b){h.removeOriginalEventListener(a,"DOMMouseScroll",l[e].actions[0]);l.splice(e,1);break}}else h.removeOriginalEventListener(a,"mousewheel",f)},onmouseenter:function(a,b,f){var e=function(k){var m=k.relatedTarget;if(m)if(this.compareDocumentPosition){var w=
this.compareDocumentPosition(m);m==this||w==20||w==0||f.call(this,k)}else m==this||this.contains(m)||f.call(this,k);else f.call(this,k)};h.addEventListener(a,"mouseover",e);l.push({element:a,eventType:b,handler:f,actions:[e]})},offmouseenter:function(a,b,f){for(var e in l)if(l[e].handler==f&&l[e].element==a&&l[e].eventType==b){h.removeEventListener(a,"mouseover",l[e].actions[0]);l.splice(e,1);break}},onmouseleave:function(a,b,f){var e=function(k){var m=k.relatedTarget;if(m)if(this.compareDocumentPosition){m=
this.compareDocumentPosition(m);m==20||m==0||f.call(this,k)}else this.contains(m)||f.call(this,k);else f.call(this,k)};h.addEventListener(a,"mouseout",e);l.push({element:a,eventType:b,handler:f,actions:[e]})},offmouseleave:function(a,b,f){for(var e in l)if(l[e].handler==f&&l[e].element==a&&l[e].eventType==b){h.removeEventListener(a,"mouseout",l[e].actions[0]);l.splice(e,1);break}},oninput:function(a,b,f){if(i.browser.ie){var e=function(k){if(k.propertyName.toLowerCase()=="value"){k=c(k,a);f.call(a,
k)}};a.attachEvent("onpropertychange",e);l.push({element:a,eventType:b,handler:f,actions:[e]});i.browser.ie==9&&h.addOriginalEventListener(a,"change",f)}else h.addOriginalEventListener(a,"input",f)},offinput:function(a,b,f){if(i.browser.ie){for(var e in l)if(l[e].handler==f&&l[e].element==a&&l[e].eventType==b){a.detachEvent("onpropertychange",l[e].actions[0]);l.splice(e,1);break}i.browser.ie==9&&h.removeOriginalEventListener(a,"change",f)}else h.removeOriginalEventListener(a,"input",f)}};d=function(a){if(d.done)return a();
if(d.timer)d.ready.push(a);else{d.ready=[a];h.on(window,"load",n);d.timer=window.setInterval(n,300)}};n=function(){if(d.done)return true;if(document&&document.getElementsByTagName&&document.getElementById&&document.body){d.done=true;window.clearInterval(d.timer);d.timer=null;for(var a=0;a<d.ready.length;a++)d.ready[a]();d.ready=null;return true}};q=function(){this.subscribers=[]};q.prototype.subscribe=function(a){i.array.some(this.subscribers,function(b){return b===a})||this.subscribers.push(a);return a};
q.prototype.deliver=function(a){i.array.forEach(this.subscribers,function(b){b(a)})};q.prototype.unsubscribe=function(a){this.subscribers=i.array.filter(this.subscribers,function(b){return b!==a});return a};g=function(a,b,f){var e,k;if(f){b="on"+b;if(!a._$events)a._$events={};if(a._$events[b]){if(a._$events[b].length==0)a._$events[b]=[]}else a._$events[b]=[];a=a._$events[b];b=a.length;e=-1;for(k=0;k<b;k++)if(a[k]==f){e=k;break}e===-1&&a.push(f)}else i.out(">>> \u6dfb\u52a0\u7684\u89c2\u5bdf\u8005\u65b9\u6cd5\u4e0d\u5b58\u5728\uff1a"+
a+b+f)};h.addEventListener=p;h.removeEventListener=r;h.addOriginalEventListener=t;h.removeOriginalEventListener=s;h.on=h.addEventListener;h.off=h.removeEventListener;h.onDomReady=d;h.Publish=q;h.addObserver=g;h.addObservers=function(a){var b=a.targetModel;a=a.eventMapping;for(var f in a)g(b,f,a[f])};h.notifyObservers=function(a,b,f){var e;b="on"+b;var k=true;if(a._$events&&a._$events[b]){b=a._$events[b];if(b.length>0)for(e=0;e<b.length;e++)if(b[e].apply(a,[f])===false)k=false}return k};h.removeObserver=
function(a,b,f){var e,k=false,m,w=a._$events;if(f){if(w){b="on"+b;if(a=w[b]){m=a.length;for(e=0;e<m;e++)if(a[e]==f){a[e]=null;a.splice(e,1);k=true;break}}}}else if(b){if(w){b="on"+b;if(a=w[b]){m=a.length;for(e=0;e<m;e++)a[e]=null;delete w[b];k=true}}}else if(a)if(w){for(e in w)delete w[e];delete a._$events;k=true}return k}});
Jx().$package(function(i){i.string=i.string||{};var h=i.string,p,t,r,s,u,l,d,n,q,g;p=function(){function c(B){k="var ";m={};m[e]=1;B=B.split(b);for(var j="",o=0,v=B.length;o<v;o++){var y=B[o].split(f);if(y.length==1)j+=a(y[0]);else{j=j;var C=y[0];if(/^=/.test(C))C=w[1]+C.substring(1).replace(/[\s;]*$/,"")+w[2];var G=C;G=G.replace(/\/\*.*?\*\/|'[^']*'|"[^"]*"|\.[\$\w]+/g,"");G=G.split(/[^\$\w\d]+/);for(var H=0,I=G.length;H<I;H++){var F=G[H];if(!(!F||A[F]||/^\d/.test(F)))if(!m[F]){k+=F==="print"?w[4]:
F+'=$data.hasOwnProperty("'+F+'")?$data.'+F+":window."+F+",";m[F]=1}}j=j+(C+"\n");j+=y[1]?a(y[1]):""}}return new Function("$data",k+w[0]+j+"return "+w[3])}function a(B){B=B.replace(/('|"|\\)/g,"\\$1").replace(/\r/g,"\\r").replace(/\n/g,"\\n");B=w[1]+'"'+B+'"'+w[2];return B+"\n"}for(var b="<%",f="%>",e="$return",k="var ",m,w="".trim?[e+' = "";',e+" +=",";",e+";","print=function(){"+e+'+=[].join.call(arguments,"")},']:[e+" = [];",e+".push(",")",e+'.join("");',"print=function(){"+e+".push.apply(arguments)},"],
...
"")};u=function(c,a){return encodeURIComponent(String(c))+"="+encodeURIComponent(String(a))};l=function(c,a){a=a||2;return c.replace(/[^\x00-\xff]/g,{2:"aa",3:"aaa"}[a]).length};d=function(c,a){return c.substring(0,c.length-a)};n=function(c){return c.replace(/[&'"<>\/\\\-\x00-\x09\x0b-\x0c\x1f\x80-\xff]/g,function(a){return"&#"+a.charCodeAt(0)+";"}).replace(/ /g,"&nbsp;").replace(/\r\n/g,"<br />").replace(/\n/g,"<br />").replace(/\r/g,"<br />")};q=function(c){return escape(c).replace(/\+/g,"%2B")};
...
b={},f={},e=0,k=r.SPEC.length;e<k;e++){var m=r.SPEC[e];if(c[m]){switch(m){case "scheme":f[m]="://";break;case "pass":b[m]=":";case "user":b.host="@";break;case "port":b[m]=":";break;case "query":b[m]="?";break;case "fragment":b[m]="#"}if(m in b)a+=b[m];if(m in c)a+=c[m];if(m in f)a+=f[m]}}return a};h.mapQuery=function(c){var a,b;c=c&&c.split("#")[0]||window.location.search;var f=c.indexOf("?"),e=c.substring(f+1).split("&"),k={};if(f===-1)return k;for(c=0;c<e.length;c++)try{f=e[c].indexOf("=");a=e[c].substring(0,
f);b=e[c].substring(f+1);if(!(k[a]=unescape(b)))throw Error("uri has wrong query string when run mapQuery.");}catch(m){}return k};h.test=function(c,a,b){return(typeof a=="string"?RegExp(a,b):a).test(c)};h.contains=function(c,a,b){return b?(b+c+b).indexOf(b+a+b)>-1:c.indexOf(a)>-1};h.trim=s;h.clean=function(c){return s(c.replace(/\s+/g," "))};h.camelCase=function(c){return c.replace(/-\D/g,function(a){return a.charAt(1).toUpperCase()})};h.hyphenate=function(c){return c.replace(/[A-Z]/g,function(a){return"-"+
...
"&#96;")};h.encodeHtmlAttribute=function(c){return c.replace(/[&'"<>\/\\\-\x00-\x1f\x80-\xff]/g,function(a){return"&#"+a.charCodeAt(0)+";"})};h.encodeHtml=n;h.encodeScript=function(c){c+="";return c.replace(/[\\"']/g,function(a){return"\\"+a}).replace(/%/g,"\\x25").replace(/\n/g,"\\n").replace(/\r/g,"\\r").replace(/\x01/g,"\\x01")};h.encodeHrefScript=function(c){return n(q(escScript(c)))};h.encodeRegExp=function(c){return c.replace(/[\\\^\$\*\+\?\{\}\.\(\)\[\]]/g,function(a){return"\\"+a})};h.encodeUrl=
...
Jx().$package(function(i){var h=i.dom.id,p=i.dom,t=i.event,r=i.string,s=this,u=i.string.mapQuery(window.location.search),l=new i.Class({_defaultType:3,_defaultTag:"information",_defaultTemplate:"<%=msg%>(<%=type%>#<%=tag%>@<%=time%>)",TYPE:["PROFILE","WARNING","ERROR","INFO","DEBUG"],init:function(d){this.msg=d.msg||"";this.tag=d.tag||this._defaultTag;this.type=i.isUndefined(d.type)?this._defaultType:d.type;this.time=(new Date).valueOf();this._template=d.template||this._defaultTemplate},format:function(d,
n,q){q=q||this._template;return n?r.encodeHtml(r.template(q,d)):r.template(q,d)},parseOption:function(){return{msg:this.msg,time:this.time,type:this.TYPE[this.type],tag:this.tag}},toString:function(d,n){return this.format(this.parseOption(),d,n||this._template)}});i.config={debugLevel:1};i.console={};i.Report={receive:i.emptyFunc,addRule:i.emptyFunc};i.extend(i.console,{_isCreated:false,_maxLength:1E3,_html:'<div id="ConsoleBoxHead" class="consoleBoxHead">                        <a href="###" id="ConsoleCloseButton" class="consoleCloseButton" title="\u5173\u95ed">X</a>                        <a href="###" id="ConsoleClearButton" class="consoleCloseButton" title="\u6e05\u9664\u6240\u6709\u65e5\u5fd7">C</a>                        <a href="###" id="ConsoleRefreshButton" class="consoleCloseButton" title="\u8fd8\u539f\u6240\u6709\u65e5\u5fd7">R</a>                        <a href="###" id="ConsoleHelpButton" class="consoleCloseButton" title="\u63a7\u5236\u53f0\u5e2e\u52a9">H</a>                        <h5 class="title" title="\u63a7\u5236\u53f0">Console</h5>                    </div>                    <div id="consoleMain" class="consoleMain">                        <ul id="ConsoleOutput" class="consoleOutput"></ul>                    </div>                    <div class="consoleInputBox">                        &gt;<input id="ConsoleInput" class="consoleInput" title="\u8bf7\u8f93\u5165\u63a7\u5236\u53f0\u6307\u4ee4\u6216\u8005Javascript\u8bed\u53e5..." />                    </div>',
...
"none";this._main.className="consoleBox";this._main.innerHTML=this._html;window.document.body.appendChild(this._main);var d=p.getClientWidth(),n=p.getClientHeight();d=d-210-300;p.setStyle(this._main,"top",n-50-310+"px");p.setStyle(this._main,"left",d+"px");this._headEl=h("ConsoleBoxHead");this._inputEl=h("ConsoleInput");this._closeButtonEl=h("ConsoleCloseButton");this._clsButtonEl=h("ConsoleClearButton");this._refreshButtonEl=h("ConsoleRefreshButton");this._helpButtonEl=h("ConsoleHelpButton");this._outputEl=
h("ConsoleOutput");this._consoleMainEl=h("consoleMain");i.ui&&i.ui.Drag&&new i.ui.Drag(this._headEl,this._main);t.on(this._inputEl,"keyup",i.bind(this.onInputKeyup,this));t.on(this._clsButtonEl,"click",i.bind(this.clear,this));t.on(this._refreshButtonEl,"click",i.bind(this.refresh,this));t.on(this._helpButtonEl,"click",i.bind(this.help,this));t.on(this._closeButtonEl,"click",i.bind(this.hide,this));n={hScrollbar:true,vScrollbar:true,checkDOMChanges:false,desktopCompatibility:true};if(i.browser.mobileSafari)if(i.ui&&
i.ui.iScroll&&!this.consoleScroller){this.consoleScroller=new i.ui.iScroll(this._outputEl,n);i.debug("!!!!2","console")}this._isCreated=true},handleDocumentKeydown:function(d){switch(d.keyCode){case 192:if(d.ctrlKey&&d.shiftKey){this.toggleShow();d.preventDefault()}}},focusCommandLine:function(){this._inputEl.focus()},toggleShow:function(){this._opened?this.hide():this.show()},outConsoleShow:function(d,n){this.outConsole(d,n);!this._opened&&i.option.console&&this.show()},outConsole:function(d){if(this._opened){var n=
document.createElement("li");this._outputEl.appendChild(n);var q=i.console._typeInfo[d.type]||i.console._typeInfo[0],g=this._templateArr[this._templateType];n.className=q[0];n.innerHTML='<div class="log_icon" title="'+q[0]+'">'+q[1]+'</div><div class="log_text">'+d.toString(true,g)+"</div>";this.consoleScroller&&this.consoleScroller.refresh();this._consoleMainEl.scrollTop=this._consoleMainEl.scrollHeight}},print:function(d){var n=document.createElement("li");this._outputEl.appendChild(n);n.innerHTML=
d;this._consoleMainEl.scrollTop=this._consoleMainEl.scrollHeight},out:function(d,n,q){var g=this._templateArr[this._templateType];d=new l({msg:d,tag:n,type:q});this.logRecord(d);if(u&&u.consolefilter){if(d.tag==u.consolefilter)this.isCustomConsole?this.outConsole(d):s.console.log(d.toString(false,g))}else this.isCustomConsole?this.outConsole(d):s.console.log(d.toString(false,g))},profile:function(d,n){n=n||"system";this.out(d,n,0)},warn:function(d,n){this.out(d,n,1)},error:function(d,n){this.out(d,
n,2)},info:function(d,n){this.out(d,n,3)},debug:function(d,n){this.out(d,n,4)},setToDebug:function(){this.isCustomConsole=u.console&&u.console=="firebug"?false:true},setToNoDebug:function(){this.out=i.emptyFunc},logRecord:function(d){this._log_record.push(d);u.console||this._log_record.length>this._maxLength&&this._log_record.shift()},setTemplate:function(d){if(this._templateArr[d])this._templateType=d},filter:function(d){var n=RegExp(d,"i"),q=[];i.array.forEach(this._log_record,function(g){var c=
g.toString(true);n.test(c)&&q.push(g)});return q},filterByType:function(d,n){var q=[];d=d||[];i.array.forEach(d,function(g){var c=false;i.array.forEach(n,function(a){if(g.type==a)c=true});c&&q.push(g)});return q},filterByTag:function(d,n){var q=[];d=d||[];i.array.forEach(d,function(g){var c=false;i.array.forEach(n,function(a){if(g.tag==a)c=true});c&&q.push(g)});return q},filterByMsg:function(d,n){var q=[];d=d||[];i.array.forEach(d,function(g){var c=false;i.array.forEach(n,function(a){if(g.msg.indexOf(a)>
-1)c=true});c&&q.push(g)});return q},getReport:function(d,n,q){var g=[],c=this._log_record,a=this;if(!d||d=="")d=false;else i.isArray(d)||(d=[d]);if(!n||n=="")n=false;else i.isArray(n)||(n=[n]);if(!q||q=="")q=false;else i.isArray(q)||(q=[q]);if(d)c=this.filterByType(c,d);if(n)c=this.filterByTag(c,n);if(q)c=this.filterByMsg(c,q);i.array.forEach(c,function(b){g.push(b.toString(false,a._templateArr[1]))});return g.join(",")},render:function(d,n){d=d||this._log_record;n||(d=d.slice(-15));var q=this;q.clear();
...
true);else{this.clear();this.out("NO RESULT!",1)}}else if(RegExp(/^(?:setTemplate|s)(?:\(|\s+)(\d+)(?:\)|\s*)$/i).test(d)){this.setTemplate(parseInt(RegExp.$1));this.refresh()}else this._execScript(d);i.console._inputEl.value=""},_execScript:function(d){var n='<span style="color:#ccff00">'+d+"</span><br/>";try{n+=(eval(d)||"").toString().replace(/</g,"&lt;").replace(/>/g,"&gt;");i.console.print(n,0)}catch(q){n+=q.description;i.console.print(n,1)}}});i.profile=i.console.profile;i.warn=i.console.warn;
i.error=i.console.error;i.info=i.console.info;i.log=i.console.log=i.console.info;i.debug=i.console.debug;t.onDomReady(function(){i.console._init();if(u.console=="true"){i.console=i.extend(i.console,{profile:i.emptyFunc,warn:i.emptyFunc,error:i.emptyFunc,info:i.emptyFunc,debug:i.emptyFunc});i.console.show()}});i.runtime=function(){function d(){return i.config.debugLevel>0}function n(g,c){var a;if(d())a=g+"\n=STACK=\n"+q();else if(c=="error")a=g;i.Debug.errorLogs.push(a)}function q(g,c){function a(e,
k){if(e.stack)return e.stack;else if(e.message.indexOf("\nBacktrace:\n")>=0){var m=0;return e.message.split("\nBacktrace:\n")[1].replace(/\s*\n\s*/g,function(){m++;return m%2==0?"\n":" @ "})}else{for(var w=k.callee==q?k.callee.caller:k.callee,z=w.arguments,A=[],x=0,E=z.length;x<E;x++)A.push(typeof z[x]=="undefined"?"<u>":z[x]===null?"<n>":z[x]);z=/function\s+([^\s\(]+)\(/;return((z.test(w.toString())?z.exec(w.toString())[1]:"<ANON>")+"("+A.join()+");").replace(/\n/g,"")}}var b;if(g instanceof Error&&
typeof arguments=="object"&&arguments.callee)b=a(g,c);else try{({}).sds()}catch(f){b=a(f,arguments)}return b.replace(/\n/g," <= ")}return{stack:q,warn:function(){n(write.apply(null,arguments),"warn")},error:function(){n(write.apply(null,arguments),"error")},isDebugMode:d}}()});
Jx().$package(function(i){var h=window.location.host;i.cookie={set:function(p,t,r,s,u){if(u){var l=new Date;l.setTime((new Date).getTime()+36E5*u)}window.document.cookie=p+"="+t+"; "+(u?"expires="+l.toGMTString()+"; ":"")+(s?"path="+s+"; ":"path=/; ")+(r?"domain="+r+";":"domain="+h+";");return true},get:function(p){p=window.document.cookie.match(RegExp("(?:^|;+|\\s+)"+p+"=([^;]*)"));return!p?"":p[1]},remove:function(p,t,r){window.document.cookie=p+"=; expires=Mon, 26 Jul 1997 05:00:00 GMT; "+(r?"path="+
...
h?h.toString().split("."):["0"],r=p?p.split("."):[""],s="",u=t[0],l=r[0],d=u.length-1,n=false,q=l.length-1;q>=0;q--)switch(l.substr(q,1)){case "":if(d>=0)s=u.substr(d--,1)+s;break;case "0":s=d>=0?u.substr(d--,1)+s:"0"+s;break;case ",":n=true;s=","+s}if(d>=0)if(n)for(l=u.length;d>=0;d--){s=u.substr(d,1)+s;if(d>0&&(l-d)%3==0)s=","+s}else s=u.substr(0,d+1)+s;s+=".";u=t.length>1?t[1]:"";l=r.length>1?r[1]:"";for(q=d=0;q<l.length;q++)switch(l.substr(q,1)){case "":if(d<u.length)s+=u.substr(d++,1);break;
case "0":s+=d<u.length?u.substr(d++,1):"0"}return s.replace(/^,+/,"").replace(/\.$/,"")}});Jx().$package(function(i){i.date=i.date||{};i.date.format=i.format.date});Jx().$package(function(i){if(window.console)for(var h=["profile","warn","error","info","debug"],p=function(u,l){return function(d){u[l](d)}},t=0,r=h.length,s;t<r;t++){s=h[t];i[s]=console[s]?p(console,s=="profile"?"log":s):p(console,"log")}});
Jx().$package(function(i){var h=i.Class({init:function(){var p=this;this.op=[{".":function(t,r){return r.className==t},"+":function(t,r){return r.getAttribute(t)},"#":function(t,r){return r.id==t},".~":function(t,r){return $D.hasClass(r,t)}},{">":function(t,r){var s,u,l;l=t.split(">");u=l[0];l=l[1];if((l=="*"?true:p.match(l,r))&&(s=p.operate(p.detectAncestor,u,r)()))return p.packEvent(r,s);return false}},{"!":function(t,r){t=t.substr(1);return!p.match(t,r)}},{"&&":function(t,r){var s,u;u=t.split("&&");
...
t){return[true,{target:t,oTarget:p.target,stopPropagation:function(){p.stopPropagation()},preventDefault:function(){p.preventDefault()},pageX:p.pageX,pageY:p.pageY}]},operate:function(p,t,r){for(var s,u=3;u>0;){if(s=this.op[0][t.substr(0,u)]){var l=null;if(l=p(t.substr(u),r,s))return l}u--}return false},match:function(p,t){for(var r=this.op2Level.length;r>0;r--){var s=this.op2Level[r];if(p.indexOf(s)!=-1)return this.op[r][s](p,t,void 0)}return this.operate(this.detect,p,t)},router:function(p,t,r){p=
...
Jx().$package(function(i){var h=i.event,p={"#":"id",".":"className","@":"el","!":"!"},t={blur:1,focus:1,change:1};i.event.eventProxy=function(r,s){var u={},l,d;for(l in s){d=s[l];var n=l.split(" "),q=n[0];n=n[1];u[n]=u[n]||[];u[n].push([q,d])}l=d=null;for(l in u){d=u[l];if(t[l]||l.charAt(0)=="@")for(n=d.length-1;n>=0;n--){q=d[n][0].split(",");for(var g=q.length-1;g>=0;g--){var c=p[q[g].charAt(0)];if(c=="id")h.on($D.id(q[g].substr(1)),l,d[n][1]);else c=="el"&&h.on(r,l.substr(1),d[n][1])}}else h.on(r,
l,function(a){for(var b=d.length-1;b>=0;b--)i.event.eventParser.parse(d[b][0],d[b][1],a)})}}});
...
else{this.onBeater(1);this.onLoop();if(b.loop<=0||--this.loop)this.time=a;else{this.stopTimer();this.onEnd()}}},stopTimer:function(){if(!this.timer)return false;this.time=i.now()-this.time;this.timer=n(this);return true},startTimer:function(){if(this.timer)return false;this.time=i.now()-this.time;this.timer=d(this);return true}}),u={},l={},d=function(a){var b=a.option.fps,f=u[b]||(u[b]=[]);f.push(a);l[b]||(l[b]=setInterval(function(){for(var e=f.length;e--;)f[e]&&f[e].update()},Math.round(1E3/b)));
return true},n=function(a){var b=a.option.fps,f=u[b]||[];i.array.remove(f,a);if(!f.length&&l[b])l[b]=clearInterval(l[b]);return false},q=new i.Class({extend:s},{init:function(a){q.superClass.init.apply(this,arguments);this.option=this.option||{};a=i.extend(this.option,{element:null,property:"",from:0,to:1,unit:false,transition:r.linear,fps:25,converter:g},a);this.from=a.from;this.to=a.to},getTransition:function(){return this.option.transition||r.sinusoidal.easeInOut},set:function(a){var b=this.option;
...
return this},resume:function(){this.startTimer();return this},stopTimer:function(){if(!this.timer)return false;this.time=i.now()-this.time;this.timer=n(this);return true},startTimer:function(){if(this.timer)return false;this.time=i.now()-this.time;this.timer=d(this);return true}});i.fx.Beater=s;i.fx.Animation=q;i.fx.Animation2=c;i.fx.transitions=r});
Jx().$package(function(i){var h=window.JSON||{};(function(){function p(q){s.lastIndex=0;return s.test(q)?'"'+q.replace(s,function(g){var c=d[g];return typeof c==="string"?c:"\\u"+("0000"+g.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+q+'"'}function t(q,g){var c,a,b,f,e=u,k,m=g[q];if(m&&typeof m==="object"&&typeof m.toJSON==="function")m=m.toJSON(q);if(typeof n==="function")m=n.call(g,q,m);switch(typeof m){case "string":return p(m);case "number":return isFinite(m)?String(m):"null";case "boolean":case "null":return String(m);
case "object":if(!m)return"null";u+=l;k=[];if(Object.prototype.toString.apply(m)==="[object Array]"){f=m.length;for(c=0;c<f;c+=1)k[c]=t(c,m)||"null";b=k.length===0?"[]":u?"[\n"+u+k.join(",\n"+u)+"\n"+e+"]":"["+k.join(",")+"]";u=e;return b}if(n&&typeof n==="object"){f=n.length;for(c=0;c<f;c+=1){a=n[c];if(typeof a==="string")if(b=t(a,m))k.push(p(a)+(u?": ":":")+b)}}else for(a in m)if(Object.hasOwnProperty.call(m,a))if(b=t(a,m))k.push(p(a)+(u?": ":":")+b);b=k.length===0?"{}":u?"{\n"+u+k.join(",\n"+u)+
"\n"+e+"}":"{"+k.join(",")+"}";u=e;return b}}var r=/[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,s=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,u,l,d={"\u0008":"\\b","\t":"\\t","\n":"\\n","\u000c":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},n;if(typeof h.stringify!=="function")h.stringify=function(q,g,c){var a;l=u="";if(typeof c==="number")for(a=0;a<c;a+=1)l+=" ";
else if(typeof c==="string")l=c;if((n=g)&&typeof g!=="function"&&(typeof g!=="object"||typeof g.length!=="number"))throw Error("JSON.stringify");return t("",{"":q})};if(typeof h.parse!=="function")h.parse=function(q,g){function c(b,f){var e,k,m=b[f];if(m&&typeof m==="object")for(e in m)if(Object.hasOwnProperty.call(m,e)){k=c(m,e);if(k!==undefined)m[e]=k;else delete m[e]}return g.call(b,f,m)}var a;r.lastIndex=0;if(r.test(q))q=q.replace(r,function(b){return"\\u"+("0000"+b.charCodeAt(0).toString(16)).slice(-4)});
...
Jx().$package(function(i){var h=i.dom.id,p=i.dom,t=i.event,r;if(typeof window.XMLHttpRequest==="undefined")window.XMLHttpRequest=function(){return new window.ActiveXObject(navigator.userAgent.indexOf("MSIE 5")>=0?"Microsoft.XMLHTTP":"Msxml2.XMLHTTP")};i.http=i.http||{};r=function(l,d,n){var q,g,c,a,b=document.getElementsByTagName("head")?document.getElementsByTagName("head")[0]:document.documentElement,f,e=false,k=false;n=n||{};var m=n.isDefer||false;g=n.query||null;arguments=n.arguments||null;var w=
n.onSuccess||function(){},z=n.onError||function(){},A=n.onComplete||function(){},x,E=n.onTimeout||function(){},D=n.timeout,B=n.charset?n.charset:"utf-8",j=n.win||window,o;d=d||"";if(g!==null)d=d+"?"+g;a=r.Id++;x=function(v){(v=h("jet_load_"+v))&&b.removeChild(v)};g=function(v,y,C){return p.node("link",{id:"jet_load_"+a,type:"text/css",charset:C||"utf-8",rel:"stylesheet",href:v},y)};c=function(v,y,C,G){v=p.node("script",{id:"jet_load_"+a,type:"text/javascript",charset:C||"utf-8",src:v},y);G&&v.setAttribute("defer",
"defer");return v};if(l==="script")q=n.node||c(d,j,B,m);else if(l==="css")q=n.node||g(d,j,B);if(i.browser.engine.trident&&parseInt(i.browser.ie)<9)q.onreadystatechange=function(){var v=this.readyState;if(v==="loaded"||v==="complete"){q.onreadystatechange=null;if(!e){k=true;window.clearTimeout(f);f=null;o={};o.id=a;o.uri=d;o.arguments=arguments;w(o);A(o)}}};else if(i.browser.engine.webkit)t.on(q,"load",function(){var v;if(!e){k=true;window.clearTimeout(f);f=null;v={};v.id=a;v.uri=d;v.arguments=arguments;
w(v);A(v);l==="script"&&x(a)}});else{q.onload=function(){var v;if(!e){k=true;window.clearTimeout(f);f=null;v={};v.id=a;v.uri=d;v.arguments=n.arguments;w(v);A(v);l==="script"&&x(a)}};q.onerror=function(v){var y;if(!e){k=true;window.clearTimeout(f);f=null;y={};y.id=a;y.uri=d;y.arguments=arguments;y.error=v;z(y);A(y);x(a)}}}if(n.node)if(l==="script")q.src=d;else{if(l==="css")q.href=d}else b.appendChild(q);if(l==="script")if(D)f=window.setTimeout(function(){var v;if(!k){e=true;v={};v.uri=d;v.arguments=
arguments;E(v);A(v);x(a)}},D);m=function(v){this._node=v;this._head=b};m.prototype={abort:function(){this._node.src="";this._head.removeChild(this._node);delete this._node}};return new m(q)};r.Id=0;var s,u={_iframes:[],_tick:0,_select:function(){this._tick++;return this._iframes[(this._tick-1)%this._len]},init:function(l){if(this._isInit!=true){this._len=l;for(var d=document.body,n=0;n<l;n++){s=p.node("div",{"class":"RPCService_hDiv"});p.hide(s);s.innerHTML='<iframe id="RPCService_hIframe_'+n+'" name="RPCService_hIframe_'+
n+'" src="'+alloy.CONST.MAIN_URL+'domain.html"></iframe>';d.appendChild(s);this._iframes[n]=[s,null,"RPCService_hIframe_"+n]}this._isInit=true}},take:function(l){var d=this._select();d[1]&&d[0].removeChild(d[1]);l.setAttribute("target",d[2]);d[1]=l;d[0].appendChild(l)}};i.http.ajax=function(l,d){var n,q,g,c=false,a=false;d={method:(d.method||"GET").toUpperCase(),data:d.data||null,arguments:d.arguments||null,onSuccess:d.onSuccess||function(){},onError:d.onError||function(){},onComplete:d.onComplete||
function(){},onTimeout:d.onTimeout||function(){},isAsync:d.isAsync||true,timeout:d.timeout||3E4,contentType:d.contentType,type:d.type||"xml"};if(d.data&&typeof d.data==="object")d.data=i.string.toQueryString(d.data);l=l||"";g=d.timeout;n=new window.XMLHttpRequest;q=function(b){try{return!b.status&&location.protocol=="file:"||b.status>=200&&b.status<300||b.status==304||navigator.userAgent.indexOf("Safari")>-1&&typeof b.status=="undefined"}catch(f){}return false};n.onreadystatechange=function(){if(n.readyState==
4){if(!c){var b={};b.responseText=n.responseText;b.responseXML=n.responseXML;b.data=d.data;b.status=n.status;b.uri=l;b.arguments=d.arguments;if(d.type==="json")try{b.responseJSON=i.json.parse(n.responseText)}catch(f){}q(n)?d.onSuccess(b):d.onError(b);d.onComplete(b)}a=true;n=null}};if(d.method==="GET"){if(d.data){l+=(l.indexOf("?")>-1?"&":"?")+d.data;d.data=null}n.open("GET",l,d.isAsync);n.setRequestHeader("Content-Type",d.contentType||"text/plain;charset=UTF-8");n.send()}else if(d.method==="POST"){n.open("POST",
l,d.isAsync);n.setRequestHeader("Content-Type",d.contentType||"application/x-www-form-urlencoded;charset=UTF-8");n.send(d.data)}else{n.open(d.method,l,d.isAsync);n.send()}window.setTimeout(function(){var b;if(!a){c=true;b={};b.uri=l;b.arguments=d.arguments;d.onTimeout(b);d.onComplete(b)}},g);return n};i.http.comet=void 0;i.http.load=r;i.http.loadCss=function(l,d){return r("css",l,d)};i.http.loadScript=function(l,d){return r("script",l,d)};i.http.formSend=function(l,d){u.init(2);var n={method:d.method||
"GET",enctype:d.enctype||"",data:d.data||{},onSuccess:d.onSuccess||function(){},onError:d.onError||function(){},onComplete:d.onComplete||function(){},onTimeout:d.onTimeout||function(){},timeout:d.timeout?d.timeout:1E4},q=p.node("form",{"class":"RPCService_form",method:n.method,action:l+"?t="+(new Date).getTime(),enctype:n.enctype});if(Object.prototype.toString.call(n.data).indexOf("String")>-1){var g=p.node("input");g.type="text";g.name=n.data;q.appendChild(g)}else for(var c in n.data){g=p.node("input");
g.type="text";g.name=c;g.setAttribute("value",n.data[c]);q.appendChild(g)}u.take(q);q.submit()}});
Jx().$package(function(i){var h=function(){function p(g,c){c=c||document;if(!/^[\w\-_#]+$/.test(g)&&c.querySelectorAll)return t(c.querySelectorAll(g));if(g.indexOf(",")>-1){for(var a=g.split(/,/g),b=[],f=0,e=a.length;f<e;++f)b=b.concat(p(a[f],c));return q(b)}a=g.match(s);f=a.pop();b=(f.match(l)||n)[1];e=!b&&(f.match(u)||n)[1];f=!b&&(f.match(d)||n)[1];if(e&&!f&&c.getElementsByClassName)f=t(c.getElementsByClassName(e));else{f=!b&&t(c.getElementsByTagName(f||"*"));if(e){f=f;e=RegExp("(^|\\s)"+e+"(\\s|$)");
for(var k=-1,m,w=-1,z=[];m=f[++k];)if(e.test(m.className))z[++w]=m;f=z}if(b)return(a=c.getElementById(b))?[a]:[]}return a[0]&&f[0]?r(a,f):f}function t(g){try{return Array.prototype.slice.call(g)}catch(c){for(var a=[],b=0,f=g.length;b<f;++b)a[b]=g[b];return a}}function r(g,c,a){var b=g.pop();if(b===">")return r(g,c,true);var f=[],e=-1,k=(b.match(l)||n)[1],m=!k&&(b.match(u)||n)[1];b=!k&&(b.match(d)||n)[1];var w=-1,z,A,x;for(b=b&&b.toLowerCase();z=c[++w];){A=z.parentNode;do{x=(x=(x=!b||b==="*"||b===
A.nodeName.toLowerCase())&&(!k||A.id===k))&&(!m||RegExp("(^|\\s)"+m+"(\\s|$)").test(A.className));if(a||x)break}while(A=A.parentNode);if(x)f[++e]=z}return g[0]&&f[0]?r(g,f):f}var s=/(?:[\w\-\\.#]+)+(?:\[\w+?=([\'"])?(?:\\\1|.)+?\1\])?|\*|>/ig,u=/^(?:[\w\-_]+)?\.([\w\-_]+)/,l=/^(?:[\w\-_]+)?#([\w\-_]+)/,d=/^([\w\*\-_]+)/,n=[null,null],q=function(){var g=+new Date,c=function(){var a=1;return function(b){var f=b[g],e=a++;if(!f){b[g]=e;return true}return false}}();return function(a){for(var b=a.length,
f=[],e=-1,k=0,m;k<b;++k){m=a[k];if(c(m))f[++e]=m}g+=1;return f}}();return p}();i.dom.mini=h});Jx().$package(function(i){i.number=i.number||{};i.number.format=i.format.number});
...
c,false)}});if(s=p.NATIVE){i.Audio=u;break}var l=[],d=function(){var g=l.length;l.pop().off("ended",d);g>=2&&l[g-2]._el.play()};i.Audio=i.Class({extend:u},{init:function(g){u.prototype.init.call(this,g)},play:function(g){var c=l.length;if(c&&l[c-1]!==this){c=i.array.indexOf(l,this);-1!==c?l.splice(c,1):this.on("ended",d)}l.push(this);if(g)this._el.src=g;this._el.paused&&this._el.play()},pause:function(){for(var g=0,c=l.length;g<c;g++)l[g].off("ended",d);l=[];this._el.pause()}});break;case p.FLASH:var n=
