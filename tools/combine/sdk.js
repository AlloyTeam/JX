	...
	var observer={
		...
		onListChange:function(list){
			...
			if(list.css.length){
				...
				var res1css='http://127.0.0.1:1337/merge/'+list.css.join()+'/jx.custom.css';
			...
			if(list.js.length){
				...
				var res1js='http://127.0.0.1:1337/merge/'+list.js.join()+'/jx.custom.js';
			...
			if(list.js.length+list.css.length){
				...
				var res2js='http://127.0.0.1:1337/merge/'+(list.css.length?list.css.join('.css,')+'.css':'')+(list.js.length?','+list.js.join():'')+'/jx.custom.js';
