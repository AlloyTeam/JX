...
.share_box_overflow .share_box_text{ overflow:hidden; }\
.share_big_quote{ position:absolute; color: #AFAFAF; font-family: Arial, Consolas; font-size: 28px; height: 16px; width:14px; text-align:center; line-height: 30px; }\
.share_left_quote{ left:5px; top:5px; }\
.ie7_0 .share_left_quote{ left:-10px; }\
.share_right_quote{ bottom:5px; right:5px; }\
.ie6_0 .share_right_quote{ bottom:-10px; }\
.share_box_footer{ height:26px; padding:2px 5px; }\
.share_box_hint{ }\
